...
@SuiteClasses({AlwaysOncycleTest.class, AssignmentAsExpressionTest.class, BitExpressionsTest.class,
		...
		IntegerExpressionsTest.class, InternalEventLifeCycleTest.class, LocalEventsTest.class, LocalReactionsTest.class,
		LogicalAndTests.class, LogicalOrTests.class, NamedInterfaceAccessTest.class, NoLocalEventsTest.class,
		OperationsTest.class, OutEventLifeCycleTest.class, ParenthesisTest.class,
		ParentFirstExecutionHierarchyTest.class, ParentFirstLocalReactionsTest.class, PedanticNoLocalEventsTest.class,
		PriorityValuesTest.class, RaiseEventTest.class, ReadOnlyVariableTest.class, SameNameDifferentRegionTest.class,
		ShallowHistoryTest.class, ShallowHistoryWithDeepEntryTest.class, SimpleEventTest.class,
		SimpleHierachyTest.class, StatechartActiveTest.class, StatechartLocalReactionsTest.class,
