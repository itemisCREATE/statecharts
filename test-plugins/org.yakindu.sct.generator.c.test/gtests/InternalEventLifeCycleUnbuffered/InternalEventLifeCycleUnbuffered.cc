...
static InternalEventLifeCycleUnbuffered * tc;


void InternalEventLifeCycleUnbuffered::SetUp()
{
...
void InternalEventLifeCycleUnbuffered::InternalEventLifeCycleUnbufferedTest()
{
...
void InternalEventLifeCycleUnbuffered::setTimer(InternalEventLifeCycle* statechart, const sc_eventid evid, const sc_integer time_ms, const sc_boolean periodic){
	sc_timer_t timer;
	sc_timer_init(&timer, time_ms, periodic, evid, statechart);
	insert_timer(&(tc->timer_service), timer);
}

void InternalEventLifeCycleUnbuffered::unsetTimer(InternalEventLifeCycle* handle, const sc_eventid evid){
	SC_UNUSED(handle);
