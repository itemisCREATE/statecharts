...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != TriggerExpressionPrecedence_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean triggerExpressionPrecedence_isStateActive(const TriggerExpressionPrecedence* handle, TriggerExpressionPrecedenceStates state)
{
	...
	{
		case TriggerExpressionPrecedence_TriggerExpressionPrecedence_main_region_A :
			result = (sc_boolean) (handle->stateConfVector[0] == TriggerExpressionPrecedence_TriggerExpressionPrecedence_main_region_A
			);
			break;
		default:
			result = bool_false;
