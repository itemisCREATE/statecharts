...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != RaiseEvent_last_state || handle->stateConfVector[1] != RaiseEvent_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean raiseEvent_isStateActive(const RaiseEvent* handle, RaiseEventStates state)
{
	...
	{
		case RaiseEvent_main_region_StateA :
			result = (sc_boolean) (handle->stateConfVector[0] == RaiseEvent_main_region_StateA
			);
			break;
		case RaiseEvent_main_region_StateB :
			result = (sc_boolean) (handle->stateConfVector[0] == RaiseEvent_main_region_StateB
			);
			break;
		case RaiseEvent_second_region_SateA :
			result = (sc_boolean) (handle->stateConfVector[1] == RaiseEvent_second_region_SateA
			);
			break;
		case RaiseEvent_second_region_StateB :
			result = (sc_boolean) (handle->stateConfVector[1] == RaiseEvent_second_region_StateB
			);
			break;
		default:
			result = bool_false;
