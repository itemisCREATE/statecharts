...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != OutEventLifeCycle_last_state || handle->stateConfVector[1] != OutEventLifeCycle_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean outEventLifeCycle_isStateActive(const OutEventLifeCycle* handle, OutEventLifeCycleStates state)
{
	...
	{
		case OutEventLifeCycle_r1_A :
			result = (sc_boolean) (handle->stateConfVector[0] == OutEventLifeCycle_r1_A
			);
			break;
		case OutEventLifeCycle_r1_B :
			result = (sc_boolean) (handle->stateConfVector[0] == OutEventLifeCycle_r1_B
			);
			break;
		case OutEventLifeCycle_r2_B :
			result = (sc_boolean) (handle->stateConfVector[1] == OutEventLifeCycle_r2_B
			);
			break;
		default:
			result = bool_false;
