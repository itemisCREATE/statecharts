...
class InternalEventLifeCycleBuffered : public ::testing::Test
{
public:
...
static InternalEventLifeCycleBuffered * tc;


void InternalEventLifeCycleBuffered::SetUp()
{
...
void InternalEventLifeCycleBuffered::InternalEventLifeCycleBufferedTest()
{
	...
	sc_timer_service_proceed_cycles(&timer_service, 1);
	EXPECT_TRUE(internalEventLifeCycle_isStateActive(&statechart, InternalEventLifeCycle_r1_B));
	EXPECT_TRUE(internalEventLifeCycle_isStateActive(&statechart, InternalEventLifeCycle_r2_C));
	sc_timer_service_proceed_cycles(&timer_service, 1);
	EXPECT_TRUE(internalEventLifeCycle_isStateActive(&statechart, InternalEventLifeCycle_r1_B));
	EXPECT_TRUE(internalEventLifeCycle_isStateActive(&statechart, InternalEventLifeCycle_r2_C));
...
void InternalEventLifeCycleBuffered::setTimer(InternalEventLifeCycle* statechart, const sc_eventid evid, const sc_integer time_ms, const sc_boolean periodic){
	sc_timer_t timer;
	sc_timer_init(&timer, time_ms, periodic, evid, statechart);
	insert_timer(&(tc->timer_service), timer);
}

void InternalEventLifeCycleBuffered::unsetTimer(InternalEventLifeCycle* handle, const sc_eventid evid){
	SC_UNUSED(handle);
	delete_task(&(tc->timer_service), find_time_event(&timer_service, evid));
}

TEST_F(InternalEventLifeCycleBuffered, InternalEventLifeCycleBufferedTest) {
