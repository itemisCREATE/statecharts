...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != SimpleEvent_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean simpleEvent_isStateActive(const SimpleEvent* handle, SimpleEventStates state)
{
	...
	{
		case SimpleEvent_main_region_A :
			result = (sc_boolean) (handle->stateConfVector[0] == SimpleEvent_main_region_A
			);
			break;
		case SimpleEvent_main_region_B :
			result = (sc_boolean) (handle->stateConfVector[0] == SimpleEvent_main_region_B
			);
			break;
		case SimpleEvent_main_region__final_ :
			result = (sc_boolean) (handle->stateConfVector[0] == SimpleEvent_main_region__final_
			);
			break;
		default:
			result = bool_false;
