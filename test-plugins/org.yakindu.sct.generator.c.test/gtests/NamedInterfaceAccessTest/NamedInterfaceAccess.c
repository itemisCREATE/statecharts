...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != NamedInterfaceAccess_last_state || handle->stateConfVector[1] != NamedInterfaceAccess_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean namedInterfaceAccess_isStateActive(const NamedInterfaceAccess* handle, NamedInterfaceAccessStates state)
{
	...
	{
		case NamedInterfaceAccess_region_1_Idle :
			result = (sc_boolean) (handle->stateConfVector[0] == NamedInterfaceAccess_region_1_Idle
			);
			break;
		case NamedInterfaceAccess_region_1_Number1Pressed :
			result = (sc_boolean) (handle->stateConfVector[0] == NamedInterfaceAccess_region_1_Number1Pressed
			);
			break;
		case NamedInterfaceAccess_region_1_Number2Pressed :
			result = (sc_boolean) (handle->stateConfVector[0] == NamedInterfaceAccess_region_1_Number2Pressed
			);
			break;
		case NamedInterfaceAccess_region_1_Number3Pressed :
			result = (sc_boolean) (handle->stateConfVector[0] == NamedInterfaceAccess_region_1_Number3Pressed
			);
			break;
		case NamedInterfaceAccess__region1_Closed :
			result = (sc_boolean) (handle->stateConfVector[1] == NamedInterfaceAccess__region1_Closed
			);
			break;
		case NamedInterfaceAccess__region1_Open :
			result = (sc_boolean) (handle->stateConfVector[1] == NamedInterfaceAccess__region1_Open
			);
			break;
		default:
			result = bool_false;
