...
sc_boolean shallowHistory_isActive(const ShallowHistory* handle)
{
	...
	for(i = 0; i < SHALLOWHISTORY_MAX_ORTHOGONAL_STATES; i++)
	{
		result = result || handle->stateConfVector[i] != ShallowHistory_last_state;
	}
...
sc_boolean shallowHistory_isStateActive(const ShallowHistory* handle, ShallowHistoryStates state)
{
	...
	{
		case ShallowHistory_mainRegion_State1 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE1] == ShallowHistory_mainRegion_State1
			);
			break;
		case ShallowHistory_mainRegion_State2 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2] >= ShallowHistory_mainRegion_State2
				&& handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2] <= ShallowHistory_mainRegion_State2__region0_State5);
			break;
		case ShallowHistory_mainRegion_State2__region0_State3 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE3] == ShallowHistory_mainRegion_State2__region0_State3
			);
			break;
		case ShallowHistory_mainRegion_State2__region0_State4 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE4] >= ShallowHistory_mainRegion_State2__region0_State4
				&& handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE4] <= ShallowHistory_mainRegion_State2__region0_State4__region0_State7__region0_State9);
			break;
		case ShallowHistory_mainRegion_State2__region0_State4__region0_State6 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE4__REGION0_STATE6] == ShallowHistory_mainRegion_State2__region0_State4__region0_State6
			);
			break;
		case ShallowHistory_mainRegion_State2__region0_State4__region0_State7 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE4__REGION0_STATE7] >= ShallowHistory_mainRegion_State2__region0_State4__region0_State7
				&& handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE4__REGION0_STATE7] <= ShallowHistory_mainRegion_State2__region0_State4__region0_State7__region0_State9);
			break;
		case ShallowHistory_mainRegion_State2__region0_State4__region0_State7__region0_State8 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE4__REGION0_STATE7__REGION0_STATE8] == ShallowHistory_mainRegion_State2__region0_State4__region0_State7__region0_State8
			);
			break;
		case ShallowHistory_mainRegion_State2__region0_State4__region0_State7__region0_State9 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE4__REGION0_STATE7__REGION0_STATE9] == ShallowHistory_mainRegion_State2__region0_State4__region0_State7__region0_State9
			);
			break;
		case ShallowHistory_mainRegion_State2__region0_State5 :
			result = (sc_boolean) (handle->stateConfVector[SCVI_SHALLOWHISTORY_MAINREGION_STATE2__REGION0_STATE5] == ShallowHistory_mainRegion_State2__region0_State5
			);
			break;
		default:
			result = bool_false;
