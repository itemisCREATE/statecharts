...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != StaticChoice_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean staticChoice_isStateActive(const StaticChoice* handle, StaticChoiceStates state)
{
	...
	{
		case StaticChoice_main_region_Start :
			result = (sc_boolean) (handle->stateConfVector[0] == StaticChoice_main_region_Start
			);
			break;
		case StaticChoice_main_region_B :
			result = (sc_boolean) (handle->stateConfVector[0] == StaticChoice_main_region_B
			);
			break;
		case StaticChoice_main_region_A :
			result = (sc_boolean) (handle->stateConfVector[0] == StaticChoice_main_region_A
			);
			break;
		default:
			result = bool_false;
