...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != ValuedEvents_last_state || handle->stateConfVector[1] != ValuedEvents_last_state || handle->stateConfVector[2] != ValuedEvents_last_state || handle->stateConfVector[3] != ValuedEvents_last_state || handle->stateConfVector[4] != ValuedEvents_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean valuedEvents_isStateActive(const ValuedEvents* handle, ValuedEventsStates state)
{
	...
	{
		case ValuedEvents_main_region1_A :
			result = (sc_boolean) (handle->stateConfVector[0] == ValuedEvents_main_region1_A
			);
			break;
		case ValuedEvents_integer_region_B :
			result = (sc_boolean) (handle->stateConfVector[1] == ValuedEvents_integer_region_B
			);
			break;
		case ValuedEvents_integer_region_C :
			result = (sc_boolean) (handle->stateConfVector[1] == ValuedEvents_integer_region_C
			);
			break;
		case ValuedEvents_integer_region_D :
			result = (sc_boolean) (handle->stateConfVector[1] == ValuedEvents_integer_region_D
			);
			break;
		case ValuedEvents_boolean_region_B :
			result = (sc_boolean) (handle->stateConfVector[2] == ValuedEvents_boolean_region_B
			);
			break;
		case ValuedEvents_boolean_region_C :
			result = (sc_boolean) (handle->stateConfVector[2] == ValuedEvents_boolean_region_C
			);
			break;
		case ValuedEvents_boolean_region_D :
			result = (sc_boolean) (handle->stateConfVector[2] == ValuedEvents_boolean_region_D
			);
			break;
		case ValuedEvents_real_region_B :
			result = (sc_boolean) (handle->stateConfVector[3] == ValuedEvents_real_region_B
			);
			break;
		case ValuedEvents_real_region_C :
			result = (sc_boolean) (handle->stateConfVector[3] == ValuedEvents_real_region_C
			);
			break;
		case ValuedEvents_real_region_D :
			result = (sc_boolean) (handle->stateConfVector[3] == ValuedEvents_real_region_D
			);
			break;
		case ValuedEvents_string_region_B :
			result = (sc_boolean) (handle->stateConfVector[4] == ValuedEvents_string_region_B
			);
			break;
		case ValuedEvents_string_region_C :
			result = (sc_boolean) (handle->stateConfVector[4] == ValuedEvents_string_region_C
			);
			break;
		case ValuedEvents_string_region_D :
			result = (sc_boolean) (handle->stateConfVector[4] == ValuedEvents_string_region_D
			);
			break;
		default:
			result = bool_false;
