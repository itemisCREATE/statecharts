...
sc_boolean stringExpressions_isActive(const StringExpressions* handle)
{
	...
	for(i = 0; i < STRINGEXPRESSIONS_MAX_ORTHOGONAL_STATES; i++)
	{
		result = result || handle->stateConfVector[i] != StringExpressions_last_state;
	}
...
sc_boolean stringExpressions_isStateActive(const StringExpressions* handle, StringExpressionsStates state)
{
	...
	{
		case StringExpressions_AssignmentChecked :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STRINGEXPRESSIONS_ASSIGNMENTCHECKED] == StringExpressions_AssignmentChecked
			);
			break;
		case StringExpressions_Failed :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STRINGEXPRESSIONS_FAILED] == StringExpressions_Failed
			);
			break;
		case StringExpressions_VarToVarCompareSucceeded :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STRINGEXPRESSIONS_VARTOVARCOMPARESUCCEEDED] == StringExpressions_VarToVarCompareSucceeded
			);
			break;
		case StringExpressions_VarToConstCompareSucceeded :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STRINGEXPRESSIONS_VARTOCONSTCOMPARESUCCEEDED] == StringExpressions_VarToConstCompareSucceeded
			);
			break;
		case StringExpressions_ConstToVarCompareSucceeded :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STRINGEXPRESSIONS_CONSTTOVARCOMPARESUCCEEDED] == StringExpressions_ConstToVarCompareSucceeded
			);
			break;
		case StringExpressions_ConstToConstCompareSucceeded :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STRINGEXPRESSIONS_CONSTTOCONSTCOMPARESUCCEEDED] == StringExpressions_ConstToConstCompareSucceeded
			);
			break;
		default:
			result = bool_false;
