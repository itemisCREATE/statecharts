...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != ReadOnlyVariable_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean readOnlyVariable_isStateActive(const ReadOnlyVariable* handle, ReadOnlyVariableStates state)
{
	...
	{
		case ReadOnlyVariable_main_region_StateB :
			result = (sc_boolean) (handle->stateConfVector[0] == ReadOnlyVariable_main_region_StateB
			);
			break;
		case ReadOnlyVariable_main_region_StateA :
			result = (sc_boolean) (handle->stateConfVector[0] == ReadOnlyVariable_main_region_StateA
			);
			break;
		default:
			result = bool_false;
