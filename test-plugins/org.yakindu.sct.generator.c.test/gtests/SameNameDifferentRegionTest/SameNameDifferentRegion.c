...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != SameNameDifferentRegion_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean sameNameDifferentRegion_isStateActive(const SameNameDifferentRegion* handle, SameNameDifferentRegionStates state)
{
	...
	{
		case SameNameDifferentRegion_main_region_StateA :
			result = (sc_boolean) (handle->stateConfVector[0] == SameNameDifferentRegion_main_region_StateA
			);
			break;
		case SameNameDifferentRegion_main_region_StateB :
			result = (sc_boolean) (handle->stateConfVector[0] >= SameNameDifferentRegion_main_region_StateB
				&& handle->stateConfVector[0] <= SameNameDifferentRegion_main_region_StateB_r1_StateB);
			break;
		case SameNameDifferentRegion_main_region_StateB_r1_StateA :
			result = (sc_boolean) (handle->stateConfVector[0] == SameNameDifferentRegion_main_region_StateB_r1_StateA
			);
			break;
		case SameNameDifferentRegion_main_region_StateB_r1_StateB :
			result = (sc_boolean) (handle->stateConfVector[0] == SameNameDifferentRegion_main_region_StateB_r1_StateB
			);
			break;
		default:
			result = bool_false;
