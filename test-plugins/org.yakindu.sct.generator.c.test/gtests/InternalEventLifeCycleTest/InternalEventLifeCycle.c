...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != InternalEventLifeCycle_last_state || handle->stateConfVector[1] != InternalEventLifeCycle_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean internalEventLifeCycle_isStateActive(const InternalEventLifeCycle* handle, InternalEventLifeCycleStates state)
{
	...
	{
		case InternalEventLifeCycle_r1_A :
			result = (sc_boolean) (handle->stateConfVector[0] == InternalEventLifeCycle_r1_A
			);
			break;
		case InternalEventLifeCycle_r1_B :
			result = (sc_boolean) (handle->stateConfVector[0] == InternalEventLifeCycle_r1_B
			);
			break;
		case InternalEventLifeCycle_r2_C :
			result = (sc_boolean) (handle->stateConfVector[1] == InternalEventLifeCycle_r2_C
			);
			break;
		case InternalEventLifeCycle_r2_D :
			result = (sc_boolean) (handle->stateConfVector[1] == InternalEventLifeCycle_r2_D
			);
			break;
		default:
			result = bool_false;
