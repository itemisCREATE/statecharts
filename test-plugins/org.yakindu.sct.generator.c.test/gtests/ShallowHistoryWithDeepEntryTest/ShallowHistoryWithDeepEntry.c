...
{
	sc_boolean result;
	if (handle->stateConfVector[0] != ShallowHistoryWithDeepEntry_last_state)
	{
		result =  bool_true;
	}
	else
...
sc_boolean shallowHistoryWithDeepEntry_isStateActive(const ShallowHistoryWithDeepEntry* handle, ShallowHistoryWithDeepEntryStates state)
{
	...
	{
		case ShallowHistoryWithDeepEntry_main_region_Y :
			result = (sc_boolean) (handle->stateConfVector[0] == ShallowHistoryWithDeepEntry_main_region_Y
			);
			break;
		case ShallowHistoryWithDeepEntry_main_region_Z :
			result = (sc_boolean) (handle->stateConfVector[0] >= ShallowHistoryWithDeepEntry_main_region_Z
				&& handle->stateConfVector[0] <= ShallowHistoryWithDeepEntry_main_region_Z__region0_B__region0_C);
			break;
		case ShallowHistoryWithDeepEntry_main_region_Z__region0_A :
			result = (sc_boolean) (handle->stateConfVector[0] == ShallowHistoryWithDeepEntry_main_region_Z__region0_A
			);
			break;
		case ShallowHistoryWithDeepEntry_main_region_Z__region0_B :
			result = (sc_boolean) (handle->stateConfVector[0] >= ShallowHistoryWithDeepEntry_main_region_Z__region0_B
				&& handle->stateConfVector[0] <= ShallowHistoryWithDeepEntry_main_region_Z__region0_B__region0_C);
			break;
		case ShallowHistoryWithDeepEntry_main_region_Z__region0_B__region0_C :
			result = (sc_boolean) (handle->stateConfVector[0] == ShallowHistoryWithDeepEntry_main_region_Z__region0_B__region0_C
			);
			break;
		default:
			result = bool_false;
