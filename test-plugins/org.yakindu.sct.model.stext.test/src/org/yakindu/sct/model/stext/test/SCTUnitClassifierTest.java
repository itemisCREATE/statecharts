...
public class SCTUnitClassifierTest {
	...
	private static final Set<EClass> IGNORE_ME = ImmutableSet.of(SGraphPackage.Literals.STATECHART,
			...
			//Replaced by types meta model
			StextPackage.Literals.OPERATION_DEFINITION, StextPackage.Literals.TYPE_ALIAS_DEFINITION, StextPackage.Literals.EVENT_DEFINITION,
