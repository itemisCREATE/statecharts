...
public class GuardStatemachine implements IGuardStatemachine {
	...
	public void enter() {
		...
		// unknown function type org.yakindu.sct.model.sexec.impl.SequenceImpl@5986b474 (name: entryAction) (comment: Entry action for statechart 'Guard'.)();
		nextStateIndex = 0;
	...
	public void exit() {
		...
		// unknown function type org.yakindu.sct.model.sexec.impl.SequenceImpl@2681f22c (name: exitAction) (comment: Exit action for state 'Guard'.)();
	}
