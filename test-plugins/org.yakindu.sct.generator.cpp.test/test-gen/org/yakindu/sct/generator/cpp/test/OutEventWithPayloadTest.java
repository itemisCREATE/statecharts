...
@GTest(
	...
	sourceFile = "gtests/OutEventWithPayload/OutEventWithPayloadTest.cc",
	program = "gtests/OutEventWithPayload/OutEventWithPayload",
	...
	additionalFilesToCompile = {
		"OutEventWithPayload.cpp",
		"sc_runner.cpp"
	}
)
@RunWith(GTestRunner.class)
public class OutEventWithPayloadTest {
