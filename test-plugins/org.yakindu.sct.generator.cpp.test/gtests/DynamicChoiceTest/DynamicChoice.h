...
class DynamicChoice : public StatemachineInterface
{
	...
	public:
		...
		*/
		...
		sc_boolean isStateActive(DynamicChoiceStates state) const;
	...
	private:
		...
		DynamicChoiceStates stateConfVector[maxOrthogonalStates];
		...
		sc_boolean check_main_region__choice_0_tr1();
