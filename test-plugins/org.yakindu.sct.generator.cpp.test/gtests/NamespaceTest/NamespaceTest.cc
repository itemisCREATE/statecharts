...
class TimedTransitionsTest : public ::testing::Test{
	...
	Yakindu::TimedTransitions* statechart;
	...
	TEST_F(TimedTransitionsTest, Timer01) {
		...
		EXPECT_TRUE(statechart->isStateActive(Yakindu::TimedTransitions::main_region_Start));
		
		runner->proceed_time(2030);
		
		runner->proceed_cycles(1);
		
		EXPECT_TRUE(statechart->isStateActive(Yakindu::TimedTransitions::main_region_End));
