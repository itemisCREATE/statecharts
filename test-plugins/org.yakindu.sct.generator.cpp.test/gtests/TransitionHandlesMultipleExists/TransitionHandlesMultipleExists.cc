...
TEST_F(TransitionHandlesMultipleExists, testTransitionHandling2Of2Exits) {
	...
	EXPECT_TRUE(statechart->isStateActive(exits::TransitionHandlesMultipleExits::main_region_A_r_AA));
	
	statechart->raise_e();
	
	EXPECT_TRUE(statechart->isStateActive(exits::TransitionHandlesMultipleExits::main_region_B_r_BB));
