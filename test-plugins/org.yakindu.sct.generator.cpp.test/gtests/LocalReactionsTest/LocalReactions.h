...
class LocalReactions : public StatemachineInterface
{
	...
	public:
		...
		*/
		...
		sc_boolean isStateActive(LocalReactionsStates state) const;
	...
	private:
		...
		LocalReactionsStates stateConfVector[maxOrthogonalStates];
