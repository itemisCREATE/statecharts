...
class GuardedExit : public StatemachineInterface
{
	...
	public:
		...
		*/
		...
		sc_boolean isStateActive(GuardedExitStates state) const;
	...
	private:
		...
		GuardedExitStates stateConfVector[maxOrthogonalStates];
