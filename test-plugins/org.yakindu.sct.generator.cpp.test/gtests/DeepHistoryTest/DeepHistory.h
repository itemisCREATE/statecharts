...
class DeepHistory : public StatemachineInterface
{
	...
	public:
		...
		*/
		...
		sc_boolean isStateActive(DeepHistoryStates state) const;
	...
	private:
		...
		static const sc_integer maxHistoryStates = 3;
		
		
		DeepHistoryStates stateConfVector[maxOrthogonalStates];
		
		DeepHistoryStates historyVector[maxHistoryStates];
		...
		sc_boolean check_mainRegion_State2__region0_a_tr0_tr0();
		...
		void effect_mainRegion_State2__region0_a_tr0();
		...
		void enseq_mainRegion_State2__region0_a_default();
		...
		void dhenseq_mainRegion_State2__region0();
		void enseq_mainRegion_State2__region0_State4__region0_default();
		void dhenseq_mainRegion_State2__region0_State4__region0();
		void enseq_mainRegion_State2__region0_State4__region0_State7__region0_default();
		void dhenseq_mainRegion_State2__region0_State4__region0_State7__region0();
		void exseq_mainRegion_State1();
		void exseq_mainRegion_State2();
		void exseq_mainRegion_State2__region0_a();
		...
		void react_mainRegion_State2__region0_a();
