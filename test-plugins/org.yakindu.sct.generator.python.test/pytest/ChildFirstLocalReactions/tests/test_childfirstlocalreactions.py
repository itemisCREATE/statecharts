...
from childfirstlocalreactions.childfirstlocalreactions_statemachine import ChildFirstLocalReactions
from tests.vtimer.virtual_timer import *

# Unit TestCase for ChildFirstLocalReactions
class ChildfirstlocalreactionsTestCase(unittest.TestCase):
	
	
	def setUp(self):
		self.statemachine = ChildFirstLocalReactions()
	...
	def test_expectBottomUpLocalReactionOrder(self):
		...
		self.assertTrue(self.statemachine.is_state_active(self.statemachine.State.childfirstlocalreactions_r_a_r_aa_r_aaa))
		self.timer.cycle_leap(1)
		self.assertTrue(self.statemachine.is_state_active(self.statemachine.State.childfirstlocalreactions_r_a_r_aa_r_aaa))
		self.assertTrue(self.statemachine.sci_interface.aaa_local == 1)
	...
	def test_expectParentLocalReactionOnChildLocalTransition(self):
		...
		self.timer.cycle_leap(1)
		self.assertTrue(self.statemachine.is_state_active(self.statemachine.State.childfirstlocalreactions_r_a_r_aa_r_aab))
		self.assertTrue(self.statemachine.sci_interface.aaa_local == 0)
		self.assertTrue(self.statemachine.sci_interface.aa_local == 1)
		self.assertTrue(self.statemachine.sci_interface.a_local == 2)
		self.assertTrue(self.statemachine.sci_interface.sm_local == 3)
	...
	def test_expectGrandparentLocalReactionOnParentLocalTransition(self):
		...
		self.statemachine.sci_interface.raise_e()
		self.timer.cycle_leap(1)
		self.assertTrue(self.statemachine.is_state_active(self.statemachine.State.childfirstlocalreactions_r_a_r_ab))
		self.assertTrue(self.statemachine.sci_interface.aaa_local == 1)
	...
	def test_expectNoLocalReactionOnGrandparentTransition(self):
		...
		self.statemachine.sci_interface.raise_e()
		self.timer.cycle_leap(1)
		self.assertTrue(self.statemachine.is_state_active(self.statemachine.State.childfirstlocalreactions_r_b))
		self.assertTrue(self.statemachine.sci_interface.aaa_local == 1)
		self.assertTrue(self.statemachine.sci_interface.aa_local == 2)
