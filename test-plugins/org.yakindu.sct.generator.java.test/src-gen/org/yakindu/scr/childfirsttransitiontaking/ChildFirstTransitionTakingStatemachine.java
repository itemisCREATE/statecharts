...
public class ChildFirstTransitionTakingStatemachine implements IChildFirstTransitionTakingStatemachine {
	...
	*/
	...
	private void enterSequence_ChildFirstTransitionTaking_r1_default() {
		react_executionorder_ChildFirstTransitionTaking_r1__entry_Default();
	}
	
	/* 'default' enter sequence for region r1 */
	private void enterSequence_ChildFirstTransitionTaking_r1_A_r1_default() {
		react_executionorder_ChildFirstTransitionTaking_r1_A_r1__entry_Default();
	}
	
	/* 'default' enter sequence for region r1 */
	private void enterSequence_ChildFirstTransitionTaking_r1_A_r1_AB_r1_default() {
		react_executionorder_ChildFirstTransitionTaking_r1_A_r1_AB_r1__entry_Default();
	}
	
	/* 'default' enter sequence for region r2 */
	private void enterSequence_ChildFirstTransitionTaking_r1_A_r1_AB_r2_default() {
		react_executionorder_ChildFirstTransitionTaking_r1_A_r1_AB_r2__entry_Default();
	}
	
	/* 'default' enter sequence for region r2 */
	private void enterSequence_ChildFirstTransitionTaking_r2_default() {
		react_executionorder_ChildFirstTransitionTaking_r2__entry_Default();
	}
	
	/* 'default' enter sequence for region r */
	private void enterSequence_ChildFirstTransitionTaking_r2_C_r_default() {
		react_executionorder_ChildFirstTransitionTaking_r2_C_r__entry_Default();
	}
	
	/* 'default' enter sequence for region r */
	private void enterSequence_ChildFirstTransitionTaking_r2_C_r_CA_r_default() {
		react_executionorder_ChildFirstTransitionTaking_r2_C_r_CA_r__entry_Default();
	}
	
	/* 'default' enter sequence for region r1 */
	private void enterSequence_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r1_default() {
		react_executionorder_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r1__entry_Default();
	}
	
	/* 'default' enter sequence for region r2 */
	private void enterSequence_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r2_default() {
		react_executionorder_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r2__entry_Default();
	}
	
	/* 'default' enter sequence for region r1 */
	private void enterSequence_ChildFirstTransitionTaking_r2_C_r_CB_r1_default() {
		react_executionorder_ChildFirstTransitionTaking_r2_C_r_CB_r1__entry_Default();
	}
	
	/* 'default' enter sequence for region r2 */
	private void enterSequence_ChildFirstTransitionTaking_r2_C_r_CB_r2_default() {
		react_executionorder_ChildFirstTransitionTaking_r2_C_r_CB_r2__entry_Default();
	}
	
	/* 'default' enter sequence for region r3 */
	private void enterSequence_ChildFirstTransitionTaking_r2_C_r_CB_r3_default() {
		react_executionorder_ChildFirstTransitionTaking_r2_C_r_CB_r3__entry_Default();
	}
	...
	private void react_executionorder_ChildFirstTransitionTaking_r1__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r1_A_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r1_A_r1__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r1_A_r1_AA_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r1_A_r1_AB_r1__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r1_A_r1_AB_r1_ABA_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r1_A_r1_AB_r2__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r1_A_r1_AB_r2_ABB_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r2_C_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2_C_r__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r2_C_r_CA_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2_C_r_CA_r__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r1__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r1_CAAA_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r2__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r2_C_r_CA_r_CAA_r2_CAAB_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2_C_r_CB_r1__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r2_C_r_CB_r1_CBA_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2_C_r_CB_r2__entry_Default() {
		enterSequence_ChildFirstTransitionTaking_r2_C_r_CB_r2_CBB_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionTaking_r2_C_r_CB_r3__entry_Default() {
