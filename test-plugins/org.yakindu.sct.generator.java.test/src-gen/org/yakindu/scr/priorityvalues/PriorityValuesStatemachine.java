...
public class PriorityValuesStatemachine implements IPriorityValuesStatemachine {
	...
	*/
	...
	private void enterSequence_someRegion_default() {
		react_PriorityValues_someRegion__entry_Default();
	}
	
	/* 'default' enter sequence for region main region */
	private void enterSequence_main_region_default() {
		react_PriorityValues_main_region__entry_Default();
	}
	...
	private void react_PriorityValues_someRegion__entry_Default() {
		enterSequence_someRegion_A_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_PriorityValues_main_region__entry_Default() {
