...
public class SimpleHierachyStatemachine implements ISimpleHierachyStatemachine {
	...
	*/
	...
	private void enterSequence_main_region_default() {
		react_SimpleHierachy_main_region__entry_Default();
	}
	
	/* 'default' enter sequence for region subregion1 */
	private void enterSequence_main_region_B_subregion1_default() {
		react_SimpleHierachy_main_region_B_subregion1__entry_Default();
	}
	...
	private void react_SimpleHierachy_main_region__entry_Default() {
		enterSequence_main_region_A_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_SimpleHierachy_main_region_B_subregion1__entry_Default() {
