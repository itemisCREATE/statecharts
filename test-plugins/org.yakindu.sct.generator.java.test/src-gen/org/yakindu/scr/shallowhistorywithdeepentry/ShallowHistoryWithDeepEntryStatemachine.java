...
public class ShallowHistoryWithDeepEntryStatemachine implements IShallowHistoryWithDeepEntryStatemachine {
	...
	*/
	...
	private void enterSequence_main_region_default() {
		react_ShallowHistoryWithDeepEntry_main_region__entry_Default();
	}
	
	/* 'default' enter sequence for region null */
	private void enterSequence_main_region_Z__region0_default() {
		react_ShallowHistoryWithDeepEntry_main_region_Z__region0__entry_Default();
	}
	...
	private void enterSequence_main_region_Z__region0_B__region0_default() {
		react_ShallowHistoryWithDeepEntry_main_region_Z__region0_B__region0__entry_Default();
	}
	...
	private void react_ShallowHistoryWithDeepEntry_main_region__entry_Default() {
		enterSequence_main_region_Y_default();
	}
	
	/* Default react sequence for shallow history entry  */
	private void react_ShallowHistoryWithDeepEntry_main_region_Z__region0__entry_Default() {
	...
	/* Default react sequence for initial entry  */
	private void react_ShallowHistoryWithDeepEntry_main_region_Z__region0_B__region0__entry_Default() {
