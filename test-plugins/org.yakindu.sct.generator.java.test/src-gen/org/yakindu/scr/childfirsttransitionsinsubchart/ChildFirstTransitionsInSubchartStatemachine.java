...
public class ChildFirstTransitionsInSubchartStatemachine implements IChildFirstTransitionsInSubchartStatemachine {
	...
	*/
	...
	private void enterSequence_ChildFirstTransitionsInSubchart_r_default() {
		react_executionorder_ChildFirstTransitionsInSubchart_r__entry_Default();
	}
	
	/* 'default' enter sequence for region r1 */
	private void enterSequence_ChildFirstTransitionsInSubchart_r_A_r1_default() {
		react_executionorder_ChildFirstTransitionsInSubchart_r_A_r1__entry_Default();
	}
	
	/* 'default' enter sequence for region r2 */
	private void enterSequence_ChildFirstTransitionsInSubchart_r_A_r2_default() {
		react_executionorder_ChildFirstTransitionsInSubchart_r_A_r2__entry_Default();
	}
	
	/* 'default' enter sequence for region r2 */
	private void enterSequence_ChildFirstTransitionsInSubchart_r2_default() {
		react_executionorder_ChildFirstTransitionsInSubchart_r2__entry_Default();
	}
	...
	private void react_executionorder_ChildFirstTransitionsInSubchart_r__entry_Default() {
		enterSequence_ChildFirstTransitionsInSubchart_r_A_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionsInSubchart_r_A_r1__entry_Default() {
		enterSequence_ChildFirstTransitionsInSubchart_r_A_r1_AA_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionsInSubchart_r_A_r2__entry_Default() {
		enterSequence_ChildFirstTransitionsInSubchart_r_A_r2_AC_default();
	}
	
	/* Default react sequence for initial entry  */
	private void react_executionorder_ChildFirstTransitionsInSubchart_r2__entry_Default() {
