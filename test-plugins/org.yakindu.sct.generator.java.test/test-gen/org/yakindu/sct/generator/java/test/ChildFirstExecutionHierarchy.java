...
public class ChildFirstExecutionHierarchy {
	...
	public void childShouldTakeTransition() {
		statemachine.enter();
		assertTrue(statemachine.isStateActive(ChildFirstExecutionHierarchyStatemachine.State.childFirstExecutionHierarchy_r_A_r_AA_r_AAA));
		statemachine.raiseE();
		timer.cycleLeap(1l);
		assertTrue(statemachine.isStateActive(ChildFirstExecutionHierarchyStatemachine.State.childFirstExecutionHierarchy_r_B));
