...
public class ChildFirstTransitionTaking {
	...
	public void testParentTransitionFromSimpleState() {
		statemachine.enter();
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r1_A_r1_AA));
		statemachine.raiseE();
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r1_B));
		statemachine.exit();
	}
	...
	public void testParentTransitionFromOrthogonalChildState() {
		...
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r1_A_r1_AB_r1_ABA));
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r1_A_r1_AB_r2_ABB));
		statemachine.raiseE();
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r1_B));
		statemachine.exit();
	}
	...
	public void testLocalReactionsOnTransitionsParentScope() {
		statemachine.enter();
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r2_C_r_CA_r_CAA));
		assertTrue(statemachine.getCLocalReaction() == 0l);
		assertTrue(statemachine.getCaLocalReaction() == 0l);
		statemachine.raiseGo();
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r2_C_r_CA_r_CAB));
		...
		statemachine.raiseE();
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r2_C_r_CB));
		assertTrue(statemachine.getCLocalReaction() == 3l);
		assertTrue(statemachine.getCaLocalReaction() == 2l);
		statemachine.raiseE();
		assertTrue(statemachine.isStateActive(ChildFirstTransitionTakingStatemachine.State.childFirstTransitionTaking_r2_C_r_CA));
