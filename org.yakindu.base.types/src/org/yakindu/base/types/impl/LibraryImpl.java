 ...
 * <ul>
 *   <li>{@link org.yakindu.base.types.impl.LibraryImpl#getName <em>Name</em>}</li>
...
public class LibraryImpl extends EObjectImpl implements Library {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.LIBRARY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.LIBRARY__NAME:
				return getName();
			case TypesPackage.LIBRARY__TYPES:
				return getTypes();
		}
