 ...
 * <ul>
 *   <li>{@link org.yakindu.sct.statechart.expressions.impl.EqualityExpressionImpl#getOperand1 <em>Operand1</em>}</li>
 *   <li>{@link org.yakindu.sct.statechart.expressions.impl.EqualityExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.yakindu.sct.statechart.expressions.impl.EqualityExpressionImpl#getOperand2 <em>Operand2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EqualityExpressionImpl extends MinimalEObjectImpl.Container implements EqualityExpression
{
  ...
  public NotificationChain basicSetOperand1(RelationalExpression newOperand1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND1, oldOperand1, newOperand1);
  ...
  public void setOperand1(RelationalExpression newOperand1)
  {
    if (newOperand1 != operand1)
    {
      ...
      if (operand1 != null)
        msgs = ((InternalEObject)operand1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND1, null, msgs);
      if (newOperand1 != null)
        msgs = ((InternalEObject)newOperand1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND1, null, msgs);
      msgs = basicSetOperand1(newOperand1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND1, newOperand1, newOperand1));
  }
  ...
  public void setOperator(EqualityOperator newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EQUALITY_EXPRESSION__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain basicSetOperand2(RelationalExpression newOperand2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND2, oldOperand2, newOperand2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOperand2(RelationalExpression newOperand2)
  {
    if (newOperand2 != operand2)
    {
      NotificationChain msgs = null;
      if (operand2 != null)
        msgs = ((InternalEObject)operand2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND2, null, msgs);
      if (newOperand2 != null)
        msgs = ((InternalEObject)newOperand2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND2, null, msgs);
      msgs = basicSetOperand2(newOperand2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND2, newOperand2, newOperand2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND1:
        return basicSetOperand1(null, msgs);
      case ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND2:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND1:
        return getOperand1();
      case ExpressionsPackage.EQUALITY_EXPRESSION__OPERATOR:
        return getOperator();
      case ExpressionsPackage.EQUALITY_EXPRESSION__OPERAND2:
        return getOperand2();
    }
