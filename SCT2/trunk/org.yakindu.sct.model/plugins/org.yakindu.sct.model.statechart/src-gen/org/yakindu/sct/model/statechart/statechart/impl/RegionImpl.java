 ...
 * <ul>
 * <li>
 * {@link org.yakindu.sct.model.statechart.statechart.impl.RegionImpl#getVertices
 * <em>Vertices</em>}</li>
 * <li>
 * {@link org.yakindu.sct.model.statechart.statechart.impl.RegionImpl#getTransitions
 * <em>Transitions</em>}</li>
 * <li>
 * {@link org.yakindu.sct.model.statechart.statechart.impl.RegionImpl#getStatechart
 * <em>Statechart</em>}</li>
 * </ul>
 * </p>
 * 
...
public class RegionImpl extends NamedElementImpl implements Region {
	...
	public EList<Vertex> getVertices() {
		if (vertices == null) {
			vertices = new EObjectContainmentWithInverseEList<Vertex>(Vertex.class, this,
					StatechartPackage.REGION__VERTICES, StatechartPackage.VERTEX__CONTAINING_REGION);
		}
		return vertices;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this,
					StatechartPackage.REGION__TRANSITIONS, StatechartPackage.TRANSITION__REGION);
		}
		return transitions;
	}
	...
	public Statechart getStatechart() {
		if (eContainerFeatureID() != StatechartPackage.REGION__STATECHART)
			return null;
	...
	public void setStatechart(Statechart newStatechart) {
		if (newStatechart != eInternalContainer()
				|| (eContainerFeatureID() != StatechartPackage.REGION__STATECHART && newStatechart != null)) {
			...
			if (newStatechart != null)
				msgs = ((InternalEObject) newStatechart).eInverseAdd(this, StatechartPackage.STATECHART__REGIONS,
						Statechart.class, msgs);
			msgs = basicSetStatechart(newStatechart, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatechartPackage.REGION__STATECHART, newStatechart,
					newStatechart));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case StatechartPackage.REGION__STATECHART:
			return eInternalContainer().eInverseRemove(this, StatechartPackage.STATECHART__REGIONS, Statechart.class,
					msgs);
		}
