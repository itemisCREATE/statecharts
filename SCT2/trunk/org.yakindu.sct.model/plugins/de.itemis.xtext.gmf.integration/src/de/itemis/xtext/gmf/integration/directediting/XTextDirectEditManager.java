package de.itemis.xtext.gmf.integration.directediting;
...
public class XTextDirectEditManager extends DirectEditManager {
	...
	private final Module xtextModule;
	private final GraphicalEditPart editPart;

	public XTextDirectEditManager(GraphicalEditPart source, Module xtextModule, CellEditorLocator locator) {
		super(source, XTextCellEditor.class, locator);
		this.editPart = source;
		this.xtextModule = xtextModule;
	}
	...
	protected CellEditor createCellEditorOn(Composite composite) {
		return new XTextCellEditor(composite, xtextModule, getResourceInScope());
	}

	protected EList<Resource> getResourceInScope() {
		return (getModel()).eResource().getResourceSet().getResources();
	}
