package org.yakindu.sct.generator.c.test.generator;
 ...
 * 
 */
public class CGeneratorTest extends AbstractGeneratorTest {
	...
	public void testExecuteGenerator() throws Exception {
		...
		IProject project = super.createTestProject("CGeneratorTest", true);
		final IFile target = project.getFile("example.sct");
		Bundle bundle = Platform.getBundle("org.yakindu.sct.generator.c.test");
		URL entry = bundle
		...
		String templatePath = "org::yakindu::sct::generator::c::templates::Main::main";
...
//		assertNotNull(((ElementReferenceExpression) ((If) executionFlow.getStates().get(0).getCycle().getSteps().get(0)).getCheck().getCondition()).getValue());
	...
	@Test public void testSimpleModel() throws Exception {
		...
		IProject project = super.createTestProject("CGeneratorTest_2", true);
