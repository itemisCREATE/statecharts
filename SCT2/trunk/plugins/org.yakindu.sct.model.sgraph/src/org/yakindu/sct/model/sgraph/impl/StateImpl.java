...
public class StateImpl extends ExpressionElementImpl implements State {
	...
	public EList<Transition> getOutgoingTransitions() {
		if (outgoingTransitions == null) {
			outgoingTransitions = new EObjectContainmentWithInverseEList<Transition>(
					Transition.class, this,
	...
	public EList<Region> getRegions() {
		if (regions == null) {
			regions = new EObjectContainmentWithInverseEList<Region>(
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
			case SGraphPackage.STATE__NAME:
				return SGraphPackage.NAMED_ELEMENT__NAME;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
			case SGraphPackage.NAMED_ELEMENT__NAME:
