    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ElementReferenceExpression_value_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ElementReferenceExpression_value_feature", "_UI_ElementReferenceExpression_type"),
         StextPackage.Literals.ELEMENT_REFERENCE_EXPRESSION__VALUE,
         true,
         false,
         true,
         null,
  ...
  {
    return getString("_UI_ElementReferenceExpression_type");
  }
