  ...
  public Sequence mapToEffect(final Transition t) {
    {
      ...
      final Function2<Sequence,State,Sequence> _function = new Function2<Sequence,State,Sequence>() {
          public Sequence apply(final Sequence seq , final State state) {
            ...
            {
              ExecutionState _create = ModelSequencer.this.factory.create(state);
              ...
              if (_operator_notEquals) {
                ...
                Call _newCall = ModelSequencer.this.factory.newCall(_exitAction_1);
                _steps.add(_newCall);
              }
      ...
      boolean _operator_notEquals_1 = ObjectExtensions.operator_notEquals(_source, null);
