...
Logical expressions in SText are similar to other programming languages. The return type is *boolean*. The operators are explained in the following table:

|_.Operator |_.Notation |
|and	| var1 && var2 |
|or | var1 || var2 |
|not | !var1 |
|conditional | var1 ? var2 : 23 |
