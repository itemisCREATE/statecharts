...
# __DebugType__ (Boolean, optional): Enables/disables the generation of a cycle based statemachine implementation
# __InterfaceEventListener__ (Boolean, optional): Enables/disables the generation of listener interfaces for the statemachine
# __Singleton__ (Boolean, optional): Enables/disables the generation of a runtime service that triggers the runcycle of a cycle based statemachine
