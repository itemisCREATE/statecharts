...
==<!-- Start sgen_feature_javatargetfeatures -->==

h4. JavaTargetFeatures

The *JavaTargetFeatures* feature allows the configuration of package names as well as class name prefix / suffix.
...
p. ==<!-- End sgen_feature_javatargetfeatures -->==	
