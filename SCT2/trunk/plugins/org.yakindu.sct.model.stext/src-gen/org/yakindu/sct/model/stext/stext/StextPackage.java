...
public interface StextPackage extends EPackage
{
   ...
   * @ordered
   */
  int ASSIGNMENT__OPERATOR = STATEMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int ASSIGNMENT__EXPRESSION = STATEMENT_FEATURE_COUNT + 2;
