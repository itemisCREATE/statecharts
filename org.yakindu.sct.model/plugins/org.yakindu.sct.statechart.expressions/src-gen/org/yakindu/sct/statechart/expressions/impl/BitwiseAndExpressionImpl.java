 ...
 * <ul>
 *   <li>{@link org.yakindu.sct.statechart.expressions.impl.BitwiseAndExpressionImpl#getOperand1 <em>Operand1</em>}</li>
 *   <li>{@link org.yakindu.sct.statechart.expressions.impl.BitwiseAndExpressionImpl#getOperand2 <em>Operand2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BitwiseAndExpressionImpl extends MinimalEObjectImpl.Container implements BitwiseAndExpression
{
  ...
  public NotificationChain basicSetOperand1(EqualityExpression newOperand1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND1, oldOperand1, newOperand1);
  ...
  public void setOperand1(EqualityExpression newOperand1)
  {
    if (newOperand1 != operand1)
    {
      ...
      if (operand1 != null)
        msgs = ((InternalEObject)operand1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND1, null, msgs);
      if (newOperand1 != null)
        msgs = ((InternalEObject)newOperand1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND1, null, msgs);
      msgs = basicSetOperand1(newOperand1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND1, newOperand1, newOperand1));
  }
  ...
  public NotificationChain basicSetOperand2(EqualityExpression newOperand2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND2, oldOperand2, newOperand2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOperand2(EqualityExpression newOperand2)
  {
    if (newOperand2 != operand2)
    {
      NotificationChain msgs = null;
      if (operand2 != null)
        msgs = ((InternalEObject)operand2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND2, null, msgs);
      if (newOperand2 != null)
        msgs = ((InternalEObject)newOperand2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND2, null, msgs);
      msgs = basicSetOperand2(newOperand2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND2, newOperand2, newOperand2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND1:
        return basicSetOperand1(null, msgs);
      case ExpressionsPackage.BITWISE_AND_EXPRESSION__OPERAND2:
