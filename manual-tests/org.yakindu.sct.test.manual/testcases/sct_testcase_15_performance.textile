...
| 15.4 | Changing preferences | <ol><li><p>In the main menu, select _Window → Preferences_.</p></li><li><p>Select _YAKINDU SCT → Diagram Appearance_.</p></li><li><p>Disable _Enable live validation_.</p></li></ol> | | %{color:red}open% |
