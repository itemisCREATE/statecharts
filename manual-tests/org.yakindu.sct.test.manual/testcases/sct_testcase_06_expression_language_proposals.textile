...
| 6.1 | Extend statechart interface | Replace the statechart specification by the following:<p>&emsp;@namespace Staircase@</p><p>&emsp;@internal:@<br>&emsp;@var light : boolean@</p><p>&emsp;@interface A:@<br>&emsp;@in event keypress@</p><p>&emsp;@interface B:@<br>&emsp;@in event keypress@</p><p>Select transition with keypress trigger and double-click on trigger.</p><p>Replace "keypress" by "A.keypress" to qualify the event.</p> <p> *save the model* | No error messages are shown. | %{color:red}open% |
