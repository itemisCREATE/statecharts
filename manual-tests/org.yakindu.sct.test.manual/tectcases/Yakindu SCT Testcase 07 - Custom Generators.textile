...
| 7.1 | Create Xpand Generator | Select the TestProject in the Package Explorer<p>Select *File->New->Project...*</p><p>Select YAKINDU SCT-> *Xpand* *Generator* *Project*</p><p>Click on Next button</p><p>Enter TestProject.generator.xpand as Project name</p><p>Check Configure for Plugin Export with following settings:</p><p>- Generator ID: custom::xpand</p><p>- Generator name: xpand text generator</p><p>- Generator class: testproject.generator.xpand.TextGenerator</p><p>- Generator description: A generator to create text</p><p>Check Create Feature Library checkbox</p><p>Click on Finish button</p> | Project *TestProject.generator.xpand* has been created in the workspace. | %{color:red}open% |
