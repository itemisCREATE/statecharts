...
/**
 * This is the item provider adapter for a {@link org.yakindu.sct.model.sexec.Return} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReturnItemProvider extends StepItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Return_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Return_value_feature", "_UI_Return_type"),
				 SexecPackage.Literals.RETURN__VALUE,
				 true,
				 false,
				 true,
				 null,
