...
public class AbstractSGenSemanticSequencer extends AbstractSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == SGenPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XbasePackage.XCLOSURE:
				...
				else if(context == grammarAccess.getXPrimaryExpressionRule() ||
				   context == grammarAccess.getXExpressionRule() ||
				   context == grammarAccess.getXAssignmentRule() ||
				   context == grammarAccess.getXAssignmentAccess().getXBinaryOperationLeftOperandAction_1_1_0_0_0() ||
				   context == grammarAccess.getXOrExpressionRule() ||
			...
			case XbasePackage.XNULL_LITERAL:
				if(context == grammarAccess.getXPrimaryExpressionRule() ||
				   ...
				   context == grammarAccess.getXNullLiteralRule()) {
					sequence_XPrimaryExpression_XNullLiteral(context, (XNullLiteral) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (parameter=[FeatureParameter|ID] expression=XExpression)
	 *
	 * Features:
	 *    parameter[1, 1]
	 *    expression[1, 1]
	 ...
	 * Features:
	 */
	protected void sequence_XPrimaryExpression_XNullLiteral(EObject context, XNullLiteral semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
