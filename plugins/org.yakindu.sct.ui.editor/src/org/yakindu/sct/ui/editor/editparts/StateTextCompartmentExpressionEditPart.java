 ...
 * 
 */
public class StateTextCompartmentExpressionEditPart extends SpecificationElementEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ContextSensitiveHelpPolicy(HelpContextIds.SC_PROPERTIES_STATE_EXPRESSION));
	}
