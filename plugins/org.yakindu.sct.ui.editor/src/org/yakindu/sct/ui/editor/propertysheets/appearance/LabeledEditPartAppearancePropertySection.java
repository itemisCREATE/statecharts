 ...
 *
 */
public class LabeledEditPartAppearancePropertySection extends ShapeColorsAndFontsPropertySection {

	@Override
	public void setInput(IWorkbenchPart part, ISelection selection) {
		super.setInput(part, SelectionUnwrapperUtil.unwrapSelectionForType(selection, BorderItemEditPart.class));
	}
}
