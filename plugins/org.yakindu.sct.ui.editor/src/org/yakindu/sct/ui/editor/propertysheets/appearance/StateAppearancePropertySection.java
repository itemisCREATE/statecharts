 ...
 *
 */
public class StateAppearancePropertySection extends ShapeColorsAndFontsPropertySection  {

	@Override
	public void setInput(IWorkbenchPart part, ISelection selection) {
		super.setInput(part, SelectionUnwrapperUtil.unwrapSelectionForType(selection, StateEditPart.class));
	}
}
