...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.mscript.typesystem.Record} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecordItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypeSystemPackage.Literals.RECORD__FIELDS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Record.class)) {
			case TypeSystemPackage.RECORD__FIELDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypeSystemPackage.Literals.RECORD__FIELDS,
				 TypeSystemFactory.eINSTANCE.createRecordField()));
	}
