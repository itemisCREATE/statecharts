...
import com.yakindu.sct.refactoring.refactor.FoldOutgoingActionsRefactoring;
/**
 * 
 * @author thomas kutz - Initial contribution and API
 * 
 */
public class FoldOutgoingActionsHandler extends
		AbstractStateRefactoringHandler {

	@Override
	public AbstractRefactoring<State> createRefactoring() {
		return new FoldOutgoingActionsRefactoring();
	}
}
