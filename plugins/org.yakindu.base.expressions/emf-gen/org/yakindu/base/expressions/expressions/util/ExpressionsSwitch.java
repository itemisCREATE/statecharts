...
public class ExpressionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExpressionsPackage.EVENT_CLEARING_EXPRESSION: {
				EventClearingExpression eventClearingExpression = (EventClearingExpression)theEObject;
				T result = caseEventClearingExpression(eventClearingExpression);
				if (result == null) result = caseExpression(eventClearingExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Event Clearing Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Event Clearing Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEventClearingExpression(EventClearingExpression object) {
		return null;
	}
