...
:
(
{ before(grammarAccess.getFeatureReferenceAccess().getFeatureNameIDTerminalRuleCall_1_0()); }
	RULE_ID{ after(grammarAccess.getFeatureReferenceAccess().getFeatureNameIDTerminalRuleCall_1_0()); }
)
