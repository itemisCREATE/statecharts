		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFeatureCallAccess().getGroup_3_1(), "rule__FeatureCall__Group_3_1__0");
					...
					put(grammarAccess.getFunctionDefinitionAccess().getReturnTypeAssignment_0(), "rule__FunctionDefinition__ReturnTypeAssignment_0");
					...
					put(grammarAccess.getFeatureCallAccess().getGlobalAssignment_0(), "rule__FeatureCall__GlobalAssignment_0");
					put(grammarAccess.getFeatureCallAccess().getNameAssignment_1(), "rule__FeatureCall__NameAssignment_1");
					put(grammarAccess.getFeatureCallAccess().getComponentReferencesAssignment_2(), "rule__FeatureCall__ComponentReferencesAssignment_2");
					put(grammarAccess.getFeatureCallAccess().getOperationCallAssignment_3_0(), "rule__FeatureCall__OperationCallAssignment_3_0");
					put(grammarAccess.getFeatureCallAccess().getArgumentsAssignment_3_1_0(), "rule__FeatureCall__ArgumentsAssignment_3_1_0");
					put(grammarAccess.getFeatureCallAccess().getArgumentsAssignment_3_1_1_1(), "rule__FeatureCall__ArgumentsAssignment_3_1_1_1");
