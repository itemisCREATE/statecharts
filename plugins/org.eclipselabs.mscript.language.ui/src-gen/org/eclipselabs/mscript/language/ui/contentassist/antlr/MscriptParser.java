		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExecuteStatementAccess().getBodyAssignment_1(), "rule__ExecuteStatement__BodyAssignment_1");
					...
					put(grammarAccess.getVariableDeclarationAccess().getConstantAssignment_0(), "rule__VariableDeclaration__ConstantAssignment_0");
