		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionDefinitionAccess().getTemplateParametersAssignment_3_1(), "rule__FunctionDefinition__TemplateParametersAssignment_3_1");
					put(grammarAccess.getFunctionDefinitionAccess().getTemplateParametersAssignment_3_2_1(), "rule__FunctionDefinition__TemplateParametersAssignment_3_2_1");
					put(grammarAccess.getFunctionDefinitionAccess().getInputParametersAssignment_5_0(), "rule__FunctionDefinition__InputParametersAssignment_5_0");
					put(grammarAccess.getFunctionDefinitionAccess().getInputParametersAssignment_5_1_1(), "rule__FunctionDefinition__InputParametersAssignment_5_1_1");
					put(grammarAccess.getFunctionDefinitionAccess().getOutputParametersAssignment_8(), "rule__FunctionDefinition__OutputParametersAssignment_8");
					put(grammarAccess.getFunctionDefinitionAccess().getOutputParametersAssignment_9_1(), "rule__FunctionDefinition__OutputParametersAssignment_9_1");
					...
					put(grammarAccess.getFunctionDefinitionAccess().getFunctorsAssignment_11_1(), "rule__FunctionDefinition__FunctorsAssignment_11_1");
					put(grammarAccess.getFunctionDefinitionAccess().getStateVariablesAssignment_11_2(), "rule__FunctionDefinition__StateVariablesAssignment_11_2");
					...
					put(grammarAccess.getIteratorCallAccess().getInitialExpressionAssignment_3_3(), "rule__IteratorCall__InitialExpressionAssignment_3_3");
