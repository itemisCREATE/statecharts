 ...
 * <ul>
 *   <li>{@link org.yakindu.model.sct.statechart.impl.ScopedElementImpl#getScopes <em>Scopes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ScopedElementImpl extends EObjectImpl implements ScopedElement {
	...
	protected EClass eStaticClass() {
		return StatechartPackage.Literals.SCOPED_ELEMENT;
	}
	...
	public EList<Scope> getScopes() {
		if (scopes == null) {
			scopes = new EObjectContainmentEList<Scope>(Scope.class, this, StatechartPackage.SCOPED_ELEMENT__SCOPES);
		}
		return scopes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatechartPackage.SCOPED_ELEMENT__SCOPES:
