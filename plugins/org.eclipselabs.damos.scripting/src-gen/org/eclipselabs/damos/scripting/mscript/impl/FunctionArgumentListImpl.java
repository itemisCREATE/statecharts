 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.FunctionArgumentListImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.FunctionArgumentListImpl#getNamedArguments <em>Named Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionArgumentListImpl extends MinimalEObjectImpl.Container implements FunctionArgumentList
{
  ...
  {
    return MscriptPackage.Literals.FUNCTION_ARGUMENT_LIST;
  }
  ...
  public EList<Expression> getArguments()
  {
    if (arguments == null)
    {
      arguments = new EObjectContainmentEList<Expression>(Expression.class, this, MscriptPackage.FUNCTION_ARGUMENT_LIST__ARGUMENTS);
    }
    return arguments;
  }
  ...
  public EList<NamedArgument> getNamedArguments()
  {
    ...
    {
      namedArguments = new EObjectContainmentEList<NamedArgument>(NamedArgument.class, this, MscriptPackage.FUNCTION_ARGUMENT_LIST__NAMED_ARGUMENTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MscriptPackage.FUNCTION_ARGUMENT_LIST__ARGUMENTS:
        return ((InternalEList<?>)getArguments()).basicRemove(otherEnd, msgs);
      case MscriptPackage.FUNCTION_ARGUMENT_LIST__NAMED_ARGUMENTS:
