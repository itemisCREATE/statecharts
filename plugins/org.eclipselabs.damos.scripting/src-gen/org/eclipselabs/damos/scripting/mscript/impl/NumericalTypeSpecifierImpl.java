 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.NumericalTypeSpecifierImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumericalTypeSpecifierImpl extends PrimitiveTypeSpecifierImpl implements NumericalTypeSpecifier
{
  ...
  {
    return MscriptPackage.Literals.NUMERICAL_TYPE_SPECIFIER;
  }
  ...
  public NotificationChain basicSetUnit(UnitExpression newUnit, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.NUMERICAL_TYPE_SPECIFIER__UNIT, oldUnit, newUnit);
  ...
  public void setUnit(UnitExpression newUnit)
  {
    if (newUnit != unit)
    {
      ...
      if (unit != null)
        msgs = ((InternalEObject)unit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.NUMERICAL_TYPE_SPECIFIER__UNIT, null, msgs);
      if (newUnit != null)
        msgs = ((InternalEObject)newUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.NUMERICAL_TYPE_SPECIFIER__UNIT, null, msgs);
      msgs = basicSetUnit(newUnit, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.NUMERICAL_TYPE_SPECIFIER__UNIT, newUnit, newUnit));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MscriptPackage.NUMERICAL_TYPE_SPECIFIER__UNIT:
