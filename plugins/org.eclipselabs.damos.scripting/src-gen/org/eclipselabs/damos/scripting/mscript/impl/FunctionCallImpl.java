 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.FunctionCallImpl#getArgumentList <em>Argument List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionCallImpl extends ExpressionImpl implements FunctionCall
{
  ...
  public NotificationChain basicSetArgumentList(FunctionArgumentList newArgumentList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.FUNCTION_CALL__ARGUMENT_LIST, oldArgumentList, newArgumentList);
  ...
  public void setArgumentList(FunctionArgumentList newArgumentList)
  {
    if (newArgumentList != argumentList)
    {
      ...
      if (argumentList != null)
        msgs = ((InternalEObject)argumentList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.FUNCTION_CALL__ARGUMENT_LIST, null, msgs);
      if (newArgumentList != null)
        msgs = ((InternalEObject)newArgumentList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.FUNCTION_CALL__ARGUMENT_LIST, null, msgs);
      msgs = basicSetArgumentList(newArgumentList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.FUNCTION_CALL__ARGUMENT_LIST, newArgumentList, newArgumentList));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MscriptPackage.FUNCTION_CALL__ARGUMENT_LIST:
