 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.LogicalAndExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogicalAndExpressionImpl extends ExpressionImpl implements LogicalAndExpression
{
  ...
  public EList<Expression> getOperands()
  {
    if (operands == null)
    {
      operands = new EObjectContainmentEList<Expression>(Expression.class, this, MscriptPackage.LOGICAL_AND_EXPRESSION__OPERANDS);
    }
    return operands;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MscriptPackage.LOGICAL_AND_EXPRESSION__OPERANDS:
