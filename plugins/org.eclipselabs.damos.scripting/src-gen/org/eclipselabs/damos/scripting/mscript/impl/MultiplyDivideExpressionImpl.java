 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.MultiplyDivideExpressionImpl#getOperands <em>Operands</em>}</li>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.MultiplyDivideExpressionImpl#getOperators <em>Operators</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MultiplyDivideExpressionImpl extends ExpressionImpl implements MultiplyDivideExpression
{
  ...
  {
    return MscriptPackage.Literals.MULTIPLY_DIVIDE_EXPRESSION;
  }
  ...
  public EList<Expression> getOperands()
  {
    if (operands == null)
    {
      operands = new EObjectContainmentEList<Expression>(Expression.class, this, MscriptPackage.MULTIPLY_DIVIDE_EXPRESSION__OPERANDS);
    }
    return operands;
  }
  ...
  public EList<MultiplyDivideOperator> getOperators()
  {
    if (operators == null)
    {
      operators = new EDataTypeEList<MultiplyDivideOperator>(MultiplyDivideOperator.class, this, MscriptPackage.MULTIPLY_DIVIDE_EXPRESSION__OPERATORS);
    }
    return operators;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MscriptPackage.MULTIPLY_DIVIDE_EXPRESSION__OPERANDS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MscriptPackage.MULTIPLY_DIVIDE_EXPRESSION__OPERANDS:
        return getOperands();
      case MscriptPackage.MULTIPLY_DIVIDE_EXPRESSION__OPERATORS:
        return getOperators();
    }
