 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.UnitExpressionImpl#getNumerator <em>Numerator</em>}</li>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.UnitExpressionImpl#getDenominator <em>Denominator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitExpressionImpl extends MinimalEObjectImpl.Container implements UnitExpression
{
  ...
  {
    return MscriptPackage.Literals.UNIT_EXPRESSION;
  }
  ...
  public NotificationChain basicSetNumerator(UnitExpressionNumerator newNumerator, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.UNIT_EXPRESSION__NUMERATOR, oldNumerator, newNumerator);
  ...
  public void setNumerator(UnitExpressionNumerator newNumerator)
  {
    if (newNumerator != numerator)
    {
      ...
      if (numerator != null)
        msgs = ((InternalEObject)numerator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.UNIT_EXPRESSION__NUMERATOR, null, msgs);
      if (newNumerator != null)
        msgs = ((InternalEObject)newNumerator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.UNIT_EXPRESSION__NUMERATOR, null, msgs);
      msgs = basicSetNumerator(newNumerator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.UNIT_EXPRESSION__NUMERATOR, newNumerator, newNumerator));
  }
  ...
  public NotificationChain basicSetDenominator(UnitExpressionDenominator newDenominator, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.UNIT_EXPRESSION__DENOMINATOR, oldDenominator, newDenominator);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDenominator(UnitExpressionDenominator newDenominator)
  {
    if (newDenominator != denominator)
    {
      NotificationChain msgs = null;
      if (denominator != null)
        msgs = ((InternalEObject)denominator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.UNIT_EXPRESSION__DENOMINATOR, null, msgs);
      if (newDenominator != null)
        msgs = ((InternalEObject)newDenominator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.UNIT_EXPRESSION__DENOMINATOR, null, msgs);
      msgs = basicSetDenominator(newDenominator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.UNIT_EXPRESSION__DENOMINATOR, newDenominator, newDenominator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MscriptPackage.UNIT_EXPRESSION__NUMERATOR:
        return basicSetNumerator(null, msgs);
      case MscriptPackage.UNIT_EXPRESSION__DENOMINATOR:
