 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.scripting.mscript.impl.UnitExpressionDenominatorImpl#getFactors <em>Factors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitExpressionDenominatorImpl extends MinimalEObjectImpl.Container implements UnitExpressionDenominator
{
  ...
  {
    return MscriptPackage.Literals.UNIT_EXPRESSION_DENOMINATOR;
  }
  ...
  public EList<UnitExpressionFactor> getFactors()
  {
    if (factors == null)
    {
      factors = new EObjectContainmentEList<UnitExpressionFactor>(UnitExpressionFactor.class, this, MscriptPackage.UNIT_EXPRESSION_DENOMINATOR__FACTORS);
    }
    return factors;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MscriptPackage.UNIT_EXPRESSION_DENOMINATOR__FACTORS:
