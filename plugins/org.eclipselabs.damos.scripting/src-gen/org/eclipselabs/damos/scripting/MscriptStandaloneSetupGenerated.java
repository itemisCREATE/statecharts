...
public class MscriptStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipselabs.damos.scripting.MscriptRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipselabs.org/damos/Mscript/1.0.0")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipselabs.org/damos/Mscript/1.0.0", org.eclipselabs.damos.scripting.mscript.MscriptPackage.eINSTANCE);
	}
