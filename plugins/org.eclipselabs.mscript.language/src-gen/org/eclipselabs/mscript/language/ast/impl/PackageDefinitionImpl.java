 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.PackageDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.PackageDefinitionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PackageDefinitionImpl extends PackageDefinitionElementImpl implements PackageDefinition
{
  ...
  {
    return AstPackage.Literals.PACKAGE_DEFINITION;
  }
  ...
  public NotificationChain basicSetName(QualifiedName newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AstPackage.PACKAGE_DEFINITION__NAME, oldName, newName);
  ...
  public void setName(QualifiedName newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AstPackage.PACKAGE_DEFINITION__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AstPackage.PACKAGE_DEFINITION__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.PACKAGE_DEFINITION__NAME, newName, newName));
  }
  ...
  public EList<PackageDefinitionElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<PackageDefinitionElement>(PackageDefinitionElement.class, this, AstPackage.PACKAGE_DEFINITION__ELEMENTS);
    }
    return elements;
  }
