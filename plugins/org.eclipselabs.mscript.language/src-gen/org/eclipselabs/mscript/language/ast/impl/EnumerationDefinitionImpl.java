 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.EnumerationDefinitionImpl#getName <em>Name</em>}</li>
...
public class EnumerationDefinitionImpl extends PackageDefinitionElementImpl implements EnumerationDefinition
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.ENUMERATION_DEFINITION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AstPackage.ENUMERATION_DEFINITION__NAME:
        return getName();
      case AstPackage.ENUMERATION_DEFINITION__LITERALS:
        return getLiterals();
    }
