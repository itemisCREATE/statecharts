 ...
 *
 */
public class IntegerValue extends AbstractExplicitDataTypeValue implements IIntegerValue {
	 ...
	 * @param integerType
	 */
	public IntegerValue(IntegerType integerType, long value) {
		super(integerType);
		this.value = value;
	}
	...
	protected IValue doConvert(DataType dataType) {
		if (dataType instanceof IntegerType) {
			return new IntegerValue(EcoreUtil.copy((IntegerType) dataType), value);
		}
	...
	protected IValue doAdd(IValue other, DataType resultDataType) {
		if (other instanceof IntegerValue) {
			return new IntegerValue((IntegerType) resultDataType, value + ((IntegerValue) other).value);
		}
		if (other instanceof RealValue) {
			return new RealValue((RealType) resultDataType, value + ((RealValue) other).doubleValue());
		}
		return InvalidValue.SINGLETON;
	}
	...
	protected IValue doUnaryMinus(DataType resultDataType) {
		return new IntegerValue((IntegerType) resultDataType, -value);
	}
	...
	protected IValue doLessThan(IValue other, DataType resultDataType) {
		if (other instanceof IntegerValue) {
			return new BooleanValue(value < ((IntegerValue) other).value);
		}
		if (other instanceof RealValue) {
			return new BooleanValue(value < ((RealValue) other).doubleValue());
		}
		return InvalidValue.SINGLETON;
	}
