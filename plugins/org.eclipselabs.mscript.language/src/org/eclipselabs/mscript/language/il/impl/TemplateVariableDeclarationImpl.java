 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.il.impl.TemplateVariableDeclarationImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateVariableDeclarationImpl extends VariableDeclarationImpl implements TemplateVariableDeclaration {
	 ...
	 * @ordered
	 */
	protected static final IValue VALUE_EDEFAULT = null;
	/**
	 ...
	 * @ordered
	 */
	protected IValue value = VALUE_EDEFAULT;
	...
	public void setValue(IValue newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ILPackage.TEMPLATE_VARIABLE_DECLARATION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ILPackage.TEMPLATE_VARIABLE_DECLARATION__VALUE:
				return getValue();
		}
