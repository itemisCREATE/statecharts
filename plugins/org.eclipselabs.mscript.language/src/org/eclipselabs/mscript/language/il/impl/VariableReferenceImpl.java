 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.il.impl.VariableReferenceImpl#getDeclaration <em>Declaration</em>}</li>
 *   <li>{@link org.eclipselabs.mscript.language.il.impl.VariableReferenceImpl#getStepIndex <em>Step Index</em>}</li>
...
public class VariableReferenceImpl extends ExpressionImpl implements VariableReference {
		...
		if (declaration != null && declaration.eIsProxy()) {
			...
			if (declaration != oldDeclaration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ILPackage.VARIABLE_REFERENCE__DECLARATION, oldDeclaration, declaration));
			}
		}
		return declaration;
	}
	...
	public void setDeclaration(VariableDeclaration newDeclaration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ILPackage.VARIABLE_REFERENCE__DECLARATION, oldDeclaration, declaration));
	}
	...
	public void setStepIndex(int newStepIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ILPackage.VARIABLE_REFERENCE__STEP_INDEX, oldStepIndex, stepIndex));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ILPackage.VARIABLE_REFERENCE__DECLARATION:
				if (resolve) return getDeclaration();
				return basicGetDeclaration();
			case ILPackage.VARIABLE_REFERENCE__STEP_INDEX:
				return getStepIndex();
			case ILPackage.VARIABLE_REFERENCE__ARRAY_INDICES:
