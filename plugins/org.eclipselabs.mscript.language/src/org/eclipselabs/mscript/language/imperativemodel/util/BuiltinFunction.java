...
public enum BuiltinFunction {
	...
	BuiltinFunction(String name, int kind, ISignature signature) {
		this.name = name;
		this.kind = kind;
	 ...
	 * 
	 */
	public static BuiltinFunction valueOf(String name, int kind) {
		for (BuiltinFunction builtinFunctions : values()) {
