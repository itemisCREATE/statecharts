...
Casting of an variable. Example: Casting an Integer to a real value.
...
==<!-- Start sgen_feature_runnablewrapperX -->==
...
# __nameSuffix__  (String, optional): The suffix for the implementing classes
...
p. ==<!-- End sgen_feature_runnablewrapperX -->==
