...
# Select _C/C++ → C Project_.<br/>!(standard-image)images/geometry_010_new_c_project_010.png(Creating a new C project)!
...
# Select the toolchain you want to work with. It contains the necessary tools for C development. By default only the toolchains supporting your local platform are displayed. Since this example has been created on a Linux machine, the toolchain *Linux GCC* is shown.<br/>!(standard-image)images/geometry_010_new_c_project_020.png(Specifying the C project's properties)!
# Click _Next >_.
# Specify platforms, configurations, and project settings. This is more specific to C than to YAKINDU Statechart Tools, so we won't go into any details here.<br/>!(standard-image)images/geometry_010_new_c_project_030.png(Specifying platforms, configurations, and project settings)!
# Click _Finish_.
...
# In the context menu, select _New → Header File_.<br/>!(standard-image)images/geometry_020_new_header_file_010.png(Creating a C header file)!
# The dialog _New Header File_ is shown. Specify the name of the header file. Here we choose *point.h*.<br/>!(standard-image)images/geometry_020_new_header_file_020.png(Select a header file name)!
# Click _Finish_. 
...
# The new statechart model is created:<br/>!(standard-image)images/geometry_030_new_statechart_model_030.png(New statechart model)!
...
!(standard-image)images/geometry_040_c_types_010.png(Using the content assist to display available types)!

p=. Using the content assist to display available types

Selecting the _Point_ menu entry completes the variable definition:

!(standard-image)images/geometry_040_c_types_020.png(A Point variable)!
...
!(standard-image)images/geometry_050_using_c_type_variables_010.png(Using C-type variables)!
...
!(standard-image)images/geometry_060_importing_namespace_010.png(Selecting a namespace to import)!
...
!(standard-image)images/geometry_170_data_structure_traversal_010.png(Content assist in data structure traversal)!
...
!(standard-image)images/geometry_080_simulation_010_statechart.png(The rectangle comparison statechart)!
...
!(standard-image)images/geometry_080_simulation_020_inspecting.png(Inspecting C data structures)!
...
!(standard-image)images/geometry_080_simulation_030_modifying.png(Modifying C data values)!
...
!(standard-image)images/geometry_080_simulation_040_rechecked.png(Rectangle areas modified and rechecked)!
...
!(standard-image)images/geometry_160_type_lookup_010.png(Looking up a C type)!
...
!(standard-image)images/geometry_083_enum_010_content_assist.png(Using content assist to select an enumeration value)!
...
!(standard-image)images/geometry_083_enum_020_simulation.png(Using content assist to select an enumeration value)!
...
!(standard-image)images/geometry_090_operations_010_content_assist.png(Using content assist to enter a C function call)!
...
!(standard-image)images/geometry_090_operations_020_calling_area.png(Using content assist to enter a C function call)!
