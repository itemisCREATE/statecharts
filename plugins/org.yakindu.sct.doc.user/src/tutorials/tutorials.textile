...
h1(#five-minutes-tutorial). Five-minutes tutorial
...
h2(#importing-light-switch-example). Importing light switch example
...
h2(#running-the-light-switch-simulation). Simulating the light switch
...
h2(#generating-statechart-code). Generating statechart code
...
That's it. If you want to know more, take the time and work through the "Comprehensive Tutorial":#comprehensive-tutorial.
