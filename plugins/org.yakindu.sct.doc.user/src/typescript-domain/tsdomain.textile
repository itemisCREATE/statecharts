...
# Open the directory folder of the Angular&nbsp;2 application by clicking on the _Directory_ button.<br/>!images/tsdomain_import2_dialog.png(Import dialog)!
# Click _Finish_. The project explorer should now look like this:<br/>!images/tsdomain_project_explorer.png(Project explorer)!
# Open the project's context menu and add the _YAKINDU SCT Nature_.<br/>!images/tsdomain_add_sct_nature.gif(Add Yakindu SCT nature)!
