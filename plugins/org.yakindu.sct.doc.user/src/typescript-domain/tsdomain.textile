h1(#tsdom-the-typescript-domain). The TypeScript domain
...
h3(#tsdom-importing-an-angular-2-project-into-eclipse). Importing an Angular&nbsp;2 project into Eclipse
...
h3(#tsdom-creating-a-statechart-model-with-the-typescript-domain). Creating a statechart model with the TypeScript domain
...
h4(#tsdom-using-a-typescript-type-variable-in-a-statechart). Using a TypeScript-type variable in a statechart
