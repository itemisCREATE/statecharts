...
p=. Figure: Unpacking the downloaded file on Windows &#91;1]
...
p=. Figure: Unpacking the downloaded file on Windows &#91;2]
...
p=. Figure: The extracted _yakindu-sct_ folder
...
p=. Figure: Contents of the extracted _yakindu-sct_ folder
...
p=. Figure: Windows security warning
...
p=. Figure: YAKINDU Statechart Tools starting up and showing a splash screen
...
p=. Figure: Selecting a workspace
...
p=. Figure: YAKINDU Statechart Tools presenting the "Welcome" window
...
p=. Figure: The YAKINDU Statechart Tools workbench
...
p=. Figure: The YAKINDU Statecharts Tools application in the "Applications" directory
...
p=. Figure: Selecting "Help → Install New Software" in the main menu
...
p=. Figure: Adding a software repository
...
p=. Figure: Selecting YAKINDU Statechart Tools software items
...
p=. Figure: Install remediation page
...
p=. Figure: Reviewing the items to be installed
...
p=. Figure: Accepting the new software's license agreements
...
p=. Figure: Installing software in progress ...
...
p=. Figure: Restarting Eclipse after software installation
...
p=. Figure: Eclipse presenting the "Welcome" window
...
p=. Figure: Selecting "Help → Check for Updates" in the main menu
...
p=. Figure: Configuring automatic update
...
p=. Figure: Features of YAKINDU Statechart Tools
...
p=. Figure: Selecting "File → New → Project..." in the main menu
...
p=. Figure: The "New Project" wizard
...
p=. Figure: "Specifying project name and location"
...
p=. Figure: Project "LightSwitch" created
...
p=. Figure: Selecting "New → Other" in the context menu
...
p=. Figure: Selecting "YAKINDU SCT → Statechart model"
...
p=. Figure: The "New YAKINDU Statechart" dialog
...
p=. Figure: Dialog "Confirm Perspective Switch"
...
p=. Figure: The statechart editor
...
p=. Figure: An error marker and a popup window explaining it
...
p=. Figure: Creating definitions &#91;1]
...
p=. Figure: Creating definitions &#91;2]
...
p=. Figure: Selecting "Run As → Statechart Simulation" in the context menu
...
p=. Figure: Light switch simulation in "off" state
...
!{width:80.0%;height:auto;}images/light_switch_320_statechart_simulator_state_events.png(Displaying event names in the statechart simulator)!

p=. Figure: Displaying event names in the statechart simulator
...
p=. Figure: Light switch simulation in "on" state
...
p=. Figure: The CallHandling statechart model
...
p=. Figure: The CallHandling statechart modeled in the statechart editor
...
p=. Figure: Selecting "New → Code Generator Model" in the context menu
...
p=. Figure: Selecting a filename for the generator model
...
p=. Figure: Selecting generator type and statechart model
...
p=. Figure: Adding the timer service feature
...
p=. Figure: Declaring "src-gen" as a source folder
...
<li><p>Right-clicking on the _src_ folder.</p></li>
<li><p>Select _New → Class_ in the context menu.</p></li>
<li><p>Name it _CallHandlingClient_.</p>
<p>!{width:80.0%;height:auto;}images/callhandling_300_java_integration_create_new_class.png!</p></li>
<li><p>Click _Finish_.</p></li>
</ol>
...
p=. Figure: Entry, exit, and final state
...
p=. Figure: Synchronization state
...
</p><table><tbody><tr class="odd"><td align="left">simple assignment</td><td align="left">@=@</td></tr><tr class="even"><td align="left">multiply and assign</td><td align="left">@*=@</td></tr><tr class="odd"><td align="left">divide and assign</td><td align="left">@/=@</td></tr><tr class="even"><td align="left">calculate modulo and assign</td><td align="left">@%=@</td></tr><tr class="odd"><td align="left">add and assign</td><td align="left">@+=@</td></tr><tr class="even"><td align="left">subtract and assign</td><td align="left">@-=@</td></tr><tr class="odd"><td align="left">bitshift left and assign</td><td align="left">@<<=@</td></tr><tr class="even"><td align="left">bitshift right and assign</td><td align="left">@>>=@</td></tr><tr class="odd"><td align="left">bitwise AND and assign</td><td align="left">@&=@</td></tr><tr class="even"><td align="left">bitwise XOR and assign</td><td align="left">@^=@</td></tr><tr class="odd"><td align="left">bitwise OR and assign</td><td align="left">@|=@</td></tr></tbody></table>
...
p=. Figure: Subdiagram popup window
...
p=. Figure: Selecting the "Save As Image File..." menu item
...
p=. Figure: The "Save As Image File" dialog
...
The _Quality (%)_ text field is active for JPEG images only. JPEG is a lossy format, and reducing the quality results in a smaller file size. However, due to the nature of statechart images, a lossless format like PNG is most often a better choice, both in quality and in file size.
...
p=. Figure: SGen generator model with default values
...
p=. Figure: The traffic light model
...
bc. extern void trafficLightWaiting_init(TrafficLightWaiting* handle);
extern void trafficLightWaiting_enter(TrafficLightWaiting* handle);
extern void trafficLightWaiting_exit(TrafficLightWaiting* handle);
extern void trafficLightWaiting_runCycle(TrafficLightWaiting* handle);
...
p=. Figure: Specifying an operation callback in the model
...
The generated interface code is shown below. Since the statechart's name is _DefaultSM_ the state machine class' name is also _DefaultSM_, to be found in the _DefaultSM.h_ file. The following is a snippet from that file.
...
==<!-- End sgen_feature_syncronizedwrapper -->==
...
If a statechart is using time events, the generated Java state machine class not only implements the @IStatemachine@ interface, but it also implements the @ITimerCallback@ interface. @ITimerCallback@ is defined as follows. It specifies a single method: @public
...
p. An additional interface @SCISampleOperationCallback@ specifying the method @public long
      myOperation(long p1, boolean p2)@ has been generated. The client code has to
...
p=. Figure: Creating an Xtend2 generator project
