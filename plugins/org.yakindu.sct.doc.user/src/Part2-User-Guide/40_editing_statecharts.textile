...
| !images/editor-palette_050_symbol_rectangle_selection.png(Editor palette symbol "Rectangle selection")! | Rectangle selection | Click and drag to select everything completely included in the selection rectangle. Submenus allow to restrict the selected objects to nodes, labels or transitions, respectively. |
| !images/editor-palette_060_symbol_intersection_selection.png(Editor palette symbol "Intersection selection")! | Intersection selection | Click and drag to select everything included in or touched by the selection rectangle. Submenus allow to restrict the selected objects to nodes, labels or transitions, respectively. |
