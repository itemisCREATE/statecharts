...
The third assertion checks whether the operation _myOperation_ has been called atleast 4 times, no matter the arguments, while the fourth assertion checks if the operation has been called exactly one time with the specified parameters.
