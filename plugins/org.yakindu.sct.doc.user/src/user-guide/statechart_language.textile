...
Variables can be _readonly_ by client code. Such variables are marked by the @readonly@ keyword. Please note that the readonly restriction is imposed on the client code only. Readonly variables can still be modified from within the statechart.
