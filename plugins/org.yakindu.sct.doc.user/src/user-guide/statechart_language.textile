...
When the _continue_ event is triggered, the most recent active state inside of the composite state _answeringQuestions_ is activated again. The respondent doesn't need to answer the previous questions again, he can simply resume.
