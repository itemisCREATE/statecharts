...
All three components are grammatically optional, though a reaction with no trigger or guard will never happen. Reactions with no effect are useful for transitions, the slash @/@ can be ommitted as well then.
