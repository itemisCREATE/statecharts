...
* A *"statechart":https://en.wikipedia.org/wiki/State_diagram#Harel_statechart* or *Harel statechart* is an extended form of the classic state diagram. However, the basic principles are the same. In this documentation, the term "statechart" usually means the graphical representation of an FSM.
* A *"state machine"* is an FSM. In this documentation, the term "state machine" usually pertains to the dynamic aspects of an FSM, i.e. it is more thought of as being executed than being depicted.
