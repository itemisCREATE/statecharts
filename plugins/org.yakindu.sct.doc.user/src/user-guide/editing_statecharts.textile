...
p(#fig_preferences-generator-model-filter). 
...
# Right-click on a project. The context menu opens.
...
# Use the _Add…_ and _Remove_ buttons to maintain a list of generator models or folders that have to be ignored for automatic build.
