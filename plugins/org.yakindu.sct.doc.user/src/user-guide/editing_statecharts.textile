...
In order to display "transition priorities":#transition-priorities in a statechart, set a check mark at the respective preference option. Section "&quot;Transition priorities&quot;":#transition-priorities has an example.
