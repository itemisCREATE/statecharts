...
h2(#edit_statechart_diagram_definition_section_appearance). Editing appearance of the statechart diagram definition section

All statechart diagrams provide a so called _Definition section_. By default, the definition section is positioned at the left side of a statechart diagram as an editable area. Within this area the main content and behaviour of the statechart can be described by providing actions, interfaces and variables. 

The definition section comes with an option to pin it to the left side of the view. In order to pin the definition section you simply have to click the small decorator icon in the upper-left corner of the area. 
...
!images/docu_editor_definition_section_pin.png(Pin the statechart diagram definition section)!

p=. Pin the statechart diagram definition section
...
You can decide, whether you want the pinned definition section contents to be visible or not. For this, the pinned definition section comes with a small decorator icon for collapsing/expanding in the upper-left corner. In collapsed state, the definition section can also be expanded by clicking on the vertical bar with the vertically aligned text "_Definition section_". By default, the pinned definition section takes 20% of the diagrams view, but you can resize it as you want.
