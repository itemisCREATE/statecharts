...
!(standard-image)images/docu_example_wizard_browse.png(Example wizard showing all available examples grouped by category)!

p=. Example wizard showing all available examples grouped by category
