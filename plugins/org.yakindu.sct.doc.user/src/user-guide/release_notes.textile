...
h2(#release_notes_3_5_0). YAKINDU Statechart Tools  3.5.0 (Jan 22, 2019 )
...
h3(#release_notes_3_5_0_eclipse_platform). Eclipse platform
...
h3(#release_notes_3_5_0_deep_java_integration). Deep Java integration (beta)
...
h3(#release_notes_3_5_0_callback_tracing). Tracing callbacks for C&#43;&#43; and Java
...
h3(#release_notes_3_5_0_QT_cpp_code_generator).  Qt C++ code generator 
...
h3(#release_notes_3_5_0_in_event_queue_cpp_code_generator). In&#45;event queue support for C&#43;&#43; code generator
...
h3(#release_notes_3_5_0_miscellaneous).  Miscellaneous

* We improved the generated code in terms of readability and removed superfluous parts (see issues "_#295_":https://github.com/Yakindu/statecharts/issues/295 and "_#227_":https://github.com/Yakindu/statecharts/issues/227).

* For the C code generator, the definition of _sc&#95;null_ changed in _sc&#95;types.h_ since the existing definition clashes with certain C compilers.* You will have to regenerate the *_*sc&#95;types.h*_* file in your workspace to remove compile errors.* "_#2555_":https://github.com/Yakindu/statecharts/issues/2555 
...
h2(#release_notes_3_4_0). YAKINDU Statechart Tools  3.4.0 (Aug 20, 2018)
...
!{width:367px;height:286px;}Pictures/100000000000024C000001CA23ED6834952995C7.png!
...
!{width:279px;height:131px;}Pictures/100002010000013D00000096E5F701A21DBDCC0A.png!
...
!{width:602px;height:420px;}Pictures/1000020100000441000002F78F05236BAAF8073B.png!
...
!{width:602px;height:230px;}Pictures/10000201000003F400000184492BB8F325907F2A.png!
...
* Added a new page to the statechart creation wizard that shows a description text for the selected statechart domain, so you can better understand what this domain stands for ("_#2097_":https://github.com/Yakindu/statecharts/issues/2097)
* Improved error message when generator model refers to non&#45;existing statechart ("_#2117_":https://github.com/Yakindu/statecharts/issues/)
* Show error message if region contains an unnamed and a 'default' named entry ("_#2051_":https://github.com/Yakindu/statecharts/issues/2051)
* Add validations and content assist for entry/exit points ("_#2088_":https://github.com/Yakindu/statecharts/issues/2088, "_#2068_":https://github.com/Yakindu/statecharts/issues/2068)
* New statecharts will be now annotated with &#64;EventDriven and &#64;ChildFirstExecution per default ("_#2073_":https://github.com/Yakindu/statecharts/issues/2073)
* Added validation rule for synchronization nodes that contain outgoing triggers ("_#2071_":https://github.com/Yakindu/statecharts/issues/2071)



Bugfixes:

* Fixed strange positioning of transition arrows at exit nodes ("_#2158_":https://github.com/Yakindu/statecharts/issues/2158)
* Fixed a bug which in certain situations made synchronization nodes being traversed while not all incoming states were active ("_#1386_":https://github.com/Yakindu/statecharts/issues/1386)
* Fixed several problems with toggling the documentation mode ("_#1939_":https://github.com/Yakindu/statecharts/issues/1939)
* Fixed usage of equally named Java operations from different interfaces during simulation ("_#2095_":https://github.com/Yakindu/statecharts/issues/2095)
* Fixed “&lt;” and “&gt;” signs being replaced with 0 and 2 in C# code generation ("_#2066_":https://github.com/Yakindu/statecharts/issues/2066)
* Removed unused functions from generated event driven Java code ("_#2020_":https://github.com/Yakindu/statecharts/issues/2020)
* Removed unused functions from generated event driven C&#43;&#43; code ("_#2019_":https://github.com/Yakindu/statecharts/issues/2019)
* Fixed rename refactoring via context menu for Linux ("_#2023_":https://github.com/Yakindu/statecharts/issues/2023)
...
* Some performance improvements for pinned definition section ("_#1976_":https://github.com/Yakindu/statecharts/issues/1976, "_#2030_":https://github.com/Yakindu/statecharts/issues/2030)
...
h2(#release_notes_3_3_0). YAKINDU Statechart Tools  3.3.0 (Mar 26, 2018)
...
h3(#release_notes_3_3_0_image_generator). Statechart image generator (Standard and Professional Edition):
...
h3(#release_notes_3_3_0_test_coverage_tracing). SCov  -  Test Coverage Tracing for SCTUnit (Professional Edition)
...
!{width:578px;height:276px;}images/release_3.3.0_scov.png!
...
h3(#release_notes_3_3_0_MISRA_short_identifiers). MISRA Short Identifiers (Professional Edition)
...
h3(#release_notes_3_3_0_Miscellaneous). Miscellaneous
...
h2(#release_notes_3_2_0). YAKINDU Statechart Tools  3.2.0 (Jan 11, 2018)
...
!{width:602px;height:626px;}Pictures/1000022900000300000003200DB0E6C019570F91.gif!
...
!{width:584px;height:401px;}Pictures/100000000000037F0000026820BB2BAE50080170.png!
...
!{width:343px;height:424px;}Pictures/1000000000000151000001A24ED820AE94EDDE85.png!
...
* Diagram syntax coloring can be activated via _Window / Preferences / YAKINDU SCT / Diagram Appearance / Syntax Coloring (https://github.com/Yakindu/statecharts/issues/1687)._
* Updated documentation regarding the execution semantics of child&#45;first/parent first and reactions (https://github.com/Yakindu/statecharts/issues/1562).
* Keyboard shortcut [Ctrl&#43;0] resets the zoom factor (https://github.com/Yakindu/statecharts/issues/1528).
* Region priorities are now shown on the canvas (https://github.com/Yakindu/statecharts/issues/475).
* The expression language now supports postfix increment and decrement operations (https://github.com/Yakindu/statecharts/issues/1739).
* Code generators check whether callback interfaces are set ("_https://github.com/Yakindu/statecharts/issues/1333_":https://github.com/Yakindu/statecharts/issues/1333).
* SCT is now fully compatible with Java 9.



h2(#release_notes_3_1_0). YAKINDU Statechart Tools  3.1.0 (Oct 4, 2017)
...
h3(#release_notes_3_1_0_new_features). New features

* Using properties and expressions in generator models ("_#325_":https://github.com/Yakindu/statecharts/issues/325)
* Named parameter calls ("_#1623_":https://github.com/Yakindu/statecharts/issues/1623)
* Option to skip generation of library files* * ("_#1645_":https://github.com/Yakindu/statecharts/issues/1645)
* New online documentation (TBD Link)

h3(#release_notes_3_1_0_generator_models). Using properties and expressions in generator models
...
An generator model may assign values to properties and later use these properties in expressions. The following sample generator model uses the *var* keyword to declare the properties _projectName_, _version_, _isBeta_, and _generateTimerServce_ with their respective types and default values.
 ...
 !{width:534px;height:362px;}Pictures/10000000000002160000016B09A5228A088C6B8D.png!
...
Read more about this feature in our user guide (link)

h3(#release_notes_3_1_0_named_paramter_calls). Named parameter calls
...
!{width:366px;height:96px;}Pictures/100000000000016F00000061559F916BB27906FE.png!
...
h3(#release_notes_3_1_0_miscellaneous). Miscellaneous improvements and bug fixes

Usability improvements

* Add a checkbox &quot;save automatically&quot; to the save dialog when running a simulation ("_#1275_":https://github.com/Yakindu/statecharts/issues/1275)
* Perspective switch for “Debug As” ("_#1646_":https://github.com/Yakindu/statecharts/issues/1646)
* Error markers of subdiagrams are not propagated to parent diagram ("_#1288_":https://github.com/Yakindu/statecharts/pull/1288)
* “Run As” context menu action available in diagram ("_#1626_":https://github.com/Yakindu/statecharts/issues/1626)
* Implicit imports for active(State) statements ("_#1294_":https://github.com/Yakindu/statecharts/issues/1294)

Code generation improvements

* “Effective C&#43;&#43;” compliant code ("_#1633_":https://github.com/Yakindu/statecharts/issues/1633" ":https://github.com/Yakindu/statecharts/issues/1634"_#1634_":https://github.com/Yakindu/statecharts/issues/1634" ":https://github.com/Yakindu/statecharts/issues/1610"_#1610_":https://github.com/Yakindu/statecharts/issues/1610)
* Removed unused includes for cycle based state machines ("_#1650_":https://github.com/Yakindu/statecharts/issues/1650)
* Provide a constant that provides the maximum number of parallel time events of a state machine ("_#1600_":https://github.com/Yakindu/statecharts/issues/1600)

Bug fixes

* [Performance] The system still slows down more and more for each successive single&#45;step ("_#1616_":https://github.com/Yakindu/statecharts/issues/1616)
* Content assist on transitions and states shows implicit variable &quot;period&quot; ("_#1586_":https://github.com/Yakindu/statecharts/issues/1586)
* Missing validation rule for top&#45;level regions without entry ("_#1363_":https://github.com/Yakindu/statecharts/issues/1363)

h2(#release_notes_3_0_0). YAKINDU Statechart Tools  3.0.0 (Jul 18, 2017)

Introducing YAKINDU Statechart Tools 3.0 Standard Edition 



We are proud to announce the new _*YAKINDU Statechart Tools Standard*_ edition. With version number 3.0 it is a major release with a bunch of great new features and a huge step for the whole YAKINDU Team! 



!{width:501px;height:303px;}Pictures/10000201000001F50000012F4248CCA2D39DEF69.png!
...
!{width:409px;height:115px;}Pictures/100002010000039900000104C424D1E9AE51C8C6.png!

!{width:373px;height:107px;}Pictures/10000201000003990000010A5A5A370424299C93.png!
...
!{width:218px;height:161px;}Pictures/10000201000000DA000000A15FDDAE15860048F1.png!
...
!{width:601px;height:369px;}Pictures/100002010000026400000177B1AE71A86AF124F6.png!
...
Choice nodes can now be resized with a fix aspect ratio ("_#1241_":https://github.com/Yakindu/statecharts/issues/1241," ":https://github.com/Yakindu/statecharts/issues/432"_#432_":https://github.com/Yakindu/statecharts/issues/432)

Perspective switches back to modeling view when simulation terminates ("_#1279_":https://github.com/Yakindu/statecharts/issues/1279)

Note attachments can be deleted now ("_#335_":https://github.com/Yakindu/statecharts/issues/335)

In simulation view, operations have a distinctive icon now ("_#723_":https://github.com/Yakindu/statecharts/issues/723)

In generator model creation wizard, the order of statechart models is aligned with the one in project explorer ("_#796_":https://github.com/Yakindu/statecharts/issues/796)

Fading time for snap&#45;to&#45;grid support lines is reduced for better user experience ("_#804_":https://github.com/Yakindu/statecharts/issues/804)

Warning for sgen files that do not contain any entries ("_#1402_":https://github.com/Yakindu/statecharts/pull/1402)

It is now possible to use binary literals like '0b01011' as integer values ("_#1385_":https://github.com/Yakindu/statecharts/issues/1385)

Hint for content assist in definition section ("_#1417_":https://github.com/Yakindu/statecharts/pull/1417)

Double click drag tracker added for notes ("_#1421_":https://github.com/Yakindu/statecharts/pull/1421)

Color of active states in simulation is changed to yellow now ("_#1277_":https://github.com/Yakindu/statecharts/issues/1277)

Disabled auto reveal on selection ("_#1393_":https://github.com/Yakindu/statecharts/issues/1393)

*Code Generation Improvements*

Removed magic numbers in generated C code ("_#1336_":https://github.com/Yakindu/statecharts/issues/1336)

Fixed isActive() method to return correct values for inactive state machines ("_#1391_":https://github.com/Yakindu/statecharts/pull/1391)

For C&#43;&#43; code generation, StatemachineInterface.h is placed into library target folder ("_#1406_":https://github.com/Yakindu/statecharts/issues/1406," ":https://github.com/Yakindu/statecharts/issues/1331"_#1331_":https://github.com/Yakindu/statecharts/issues/1331)

*Bug Fixes*

Fix display of error markers ("_#1340_":https://github.com/Yakindu/statecharts/issues/1340," ":https://github.com/Yakindu/statecharts/issues/1339"_#1339_":https://github.com/Yakindu/statecharts/issues/1339)

Fix TODO and FIXME markers ("_#1429_":https://github.com/Yakindu/statecharts/issues/1429)

Bug in AbstractTypeSystem.remove(Type) ("_#1477_":https://github.com/Yakindu/statecharts/issues/1477)
...
The product bundle of SCT is now shipped with"_ Eclipse Oxygen_":https://www.eclipse.org/eclipse/news/4.7/ as underlying platform which comes with several improvements as compared to the Neon release. However, SCT does not require Oxygen to be installed. You can still install the SCT plugins with a Mars or Neon based IDE.
...
*YAKINDU SCT 3.0 Professional Edition*

The new release of the Standard Edition's big brother is also available. &lt;Learn more about the Professional Edition&gt; . * *
