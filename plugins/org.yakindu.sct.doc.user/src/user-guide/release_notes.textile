...
h2(#release_notes_3.5.13). YAKINDU Statechart Tools  3.5.13 (Sep 04, 2020)
...
* Fixed an issue in the C code generator that produced operation names missing the name of the interface in which they are defined.
