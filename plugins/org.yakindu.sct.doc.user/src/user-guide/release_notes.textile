...
h3(#release_notes_3.5.3_java_domain). Java Domain

The transformation of Java code now also takes interface methods into account which do not have an explicit _public_ modifier. 

Similarly, interface constants are also transformed and can be accessed in the statechart model.


h3(#release_notes_3.5.3_misc). Misc

In addition, this release contains the following fixes:
