...
Pick one of the following commands depending on your platform 

Windows

bc. 
eclipsec.exe --launcher headless.ini -basedir E:\sctHeadless\workspace -m test.standalone\default.sct -sgen test.standalone\c.sgen

Linux

bc. 
./SCT --launcher.ini headless.ini -basedir E:\sctHeadless\workspace -m test.standalone\default.sct -sgen test.standalone\c.sgen
