...
To get a clue how to integrate a generated C state machine with your project have a look at this @main.c@ file and its @main()@ method. Please note that the @trafficLight_setTimer@ and @trafficLight_unsetTimer@ functions are implemented here as well:
