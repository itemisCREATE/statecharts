...
public class SexecSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SexecPackage.DO_WHILE: {
				DoWhile doWhile = (DoWhile)theEObject;
				T result = caseDoWhile(doWhile);
				if (result == null) result = caseStep(doWhile);
				if (result == null) result = caseNamedElement(doWhile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
