...
public class ContextPredicateProvider {
	...
	protected void initMap() {
		...
		filter.put(key(BITWISE_XOR_EXPRESSION), or(VARIABLES, OPERATIONS));
		filter.put(key(BITWISE_OR_EXPRESSION), or(VARIABLES, OPERATIONS));
		filter.put(key(BITWISE_AND_EXPRESSION), or(VARIABLES, OPERATIONS));
		filter.put(key(SHIFT_EXPRESSION), or(VARIABLES, OPERATIONS));
		...
		filter.put(key(TRANSITION_REACTION), or(VARIABLES, OPERATIONS, ENUMERATIONS));
