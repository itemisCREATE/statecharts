...
public interface IValueFactory {
	...
	IRealValue createRealValue(IComputationContext context, RealType realType, double value);
	IIntegerValue createIntegerValue(IComputationContext context, IntegerType integerType, long value);
