 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.typesystem.impl.RecordFieldImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipselabs.mscript.typesystem.impl.RecordFieldImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RecordFieldImpl extends EObjectImpl implements RecordField {
	/**
	...
	protected EClass eStaticClass() {
		return TypeSystemPackage.Literals.RECORD_FIELD;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeSystemPackage.RECORD_FIELD__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(DataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeSystemPackage.RECORD_FIELD__TYPE, oldType, type));
	}
