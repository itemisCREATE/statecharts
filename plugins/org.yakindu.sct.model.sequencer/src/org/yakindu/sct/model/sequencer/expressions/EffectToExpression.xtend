...
import org.yakindu.sct.model.sequencer.vectors.ImpactVector
...
//			}
	...
	def List<Expression> mapToStateConfigurationEnterSequence(List<Transition> transitions) {
		...
		if (entryScope !== null) entryScope.addEnterExpForTargetsToSequence(targets, sequence)	
		else {
	...
	def protected dispatch void addEnterExpForTargetsToSequence(EObject it, List<TargetEntrySpec> targets, List<Expression> seq) {
		// fallback
	}
