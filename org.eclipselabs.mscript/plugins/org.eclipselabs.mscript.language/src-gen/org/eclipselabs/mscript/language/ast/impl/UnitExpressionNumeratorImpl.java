 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.UnitExpressionNumeratorImpl#getOne <em>One</em>}</li>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.UnitExpressionNumeratorImpl#getFactors <em>Factors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitExpressionNumeratorImpl extends MinimalEObjectImpl.Container implements UnitExpressionNumerator
{
  ...
  {
    return AstPackage.Literals.UNIT_EXPRESSION_NUMERATOR;
  }
  ...
  public void setOne(long newOne)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.UNIT_EXPRESSION_NUMERATOR__ONE, oldOne, one));
  }
  ...
  public EList<UnitExpressionFactor> getFactors()
  {
    if (factors == null)
    {
      factors = new EObjectContainmentEList<UnitExpressionFactor>(UnitExpressionFactor.class, this, AstPackage.UNIT_EXPRESSION_NUMERATOR__FACTORS);
    }
    return factors;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AstPackage.UNIT_EXPRESSION_NUMERATOR__FACTORS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AstPackage.UNIT_EXPRESSION_NUMERATOR__ONE:
        return getOne();
      case AstPackage.UNIT_EXPRESSION_NUMERATOR__FACTORS:
        return getFactors();
    }
