 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.MultiplicativeExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.MultiplicativeExpressionImpl#getLeftOperand <em>Left Operand</em>}</li>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.MultiplicativeExpressionImpl#getRightOperand <em>Right Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MultiplicativeExpressionImpl extends ExpressionImpl implements MultiplicativeExpression {
	...
	public void setOperator(MultiplicativeOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.MULTIPLICATIVE_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain basicSetRightOperand(Expression newRightOperand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AstPackage.MULTIPLICATIVE_EXPRESSION__RIGHT_OPERAND, oldRightOperand, newRightOperand);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRightOperand(Expression newRightOperand) {
		if (newRightOperand != rightOperand) {
			...
			if (rightOperand != null)
				msgs = ((InternalEObject)rightOperand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AstPackage.MULTIPLICATIVE_EXPRESSION__RIGHT_OPERAND, null, msgs);
			if (newRightOperand != null)
				msgs = ((InternalEObject)newRightOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AstPackage.MULTIPLICATIVE_EXPRESSION__RIGHT_OPERAND, null, msgs);
			msgs = basicSetRightOperand(newRightOperand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.MULTIPLICATIVE_EXPRESSION__RIGHT_OPERAND, newRightOperand, newRightOperand));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AstPackage.MULTIPLICATIVE_EXPRESSION__RIGHT_OPERAND:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AstPackage.MULTIPLICATIVE_EXPRESSION__OPERATOR:
				return getOperator();
			case AstPackage.MULTIPLICATIVE_EXPRESSION__LEFT_OPERAND:
