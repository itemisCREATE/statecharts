 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.DoWhileStatementImpl#getCondition <em>Condition</em>}</li>
...
public class DoWhileStatementImpl extends StatementImpl implements DoWhileStatement {
	...
	public NotificationChain basicSetCondition(Expression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AstPackage.DO_WHILE_STATEMENT__CONDITION, oldCondition, newCondition);
	...
	public void setCondition(Expression newCondition) {
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AstPackage.DO_WHILE_STATEMENT__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AstPackage.DO_WHILE_STATEMENT__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.DO_WHILE_STATEMENT__CONDITION, newCondition, newCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AstPackage.DO_WHILE_STATEMENT__CONDITION:
