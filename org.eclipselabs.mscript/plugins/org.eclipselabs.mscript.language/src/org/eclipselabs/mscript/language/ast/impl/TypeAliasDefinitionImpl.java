 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.TypeAliasDefinitionImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TypeAliasDefinitionImpl extends DataTypeDefinitionImpl implements TypeAliasDefinition {
	/**
	...
	protected EClass eStaticClass() {
		return AstPackage.Literals.TYPE_ALIAS_DEFINITION;
	}
	...
	public void setType(PrimitiveTypeSpecifier newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AstPackage.TYPE_ALIAS_DEFINITION__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AstPackage.TYPE_ALIAS_DEFINITION__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.TYPE_ALIAS_DEFINITION__TYPE, newType, newType));
	}
