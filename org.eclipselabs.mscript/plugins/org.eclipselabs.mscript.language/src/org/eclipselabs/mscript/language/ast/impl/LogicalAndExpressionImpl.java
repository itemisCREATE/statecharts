 ...
 * <ul>
 *   <li>{@link org.eclipselabs.mscript.language.ast.impl.LogicalAndExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogicalAndExpressionImpl extends ExpressionImpl implements LogicalAndExpression {
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, AstPackage.LOGICAL_AND_EXPRESSION__OPERANDS);
		}
		return operands;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AstPackage.LOGICAL_AND_EXPRESSION__OPERANDS:
