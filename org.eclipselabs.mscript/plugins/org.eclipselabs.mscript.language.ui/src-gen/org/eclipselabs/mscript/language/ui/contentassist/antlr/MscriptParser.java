		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTestAccess().getGroup_3_2(), "rule__Test__Group_3_2__0");
					...
					put(grammarAccess.getTestAccess().getGroup_9(), "rule__Test__Group_9__0");
					...
					put(grammarAccess.getFunctionDefinitionAccess().getTestsAssignment_11_0(), "rule__FunctionDefinition__TestsAssignment_11_0");
					...
					put(grammarAccess.getTestAccess().getTemplateArgumentsAssignment_3_1(), "rule__Test__TemplateArgumentsAssignment_3_1");
					put(grammarAccess.getTestAccess().getTemplateArgumentsAssignment_3_2_1(), "rule__Test__TemplateArgumentsAssignment_3_2_1");
					put(grammarAccess.getTestAccess().getInputParameterTypesAssignment_5_0(), "rule__Test__InputParameterTypesAssignment_5_0");
					put(grammarAccess.getTestAccess().getInputParameterTypesAssignment_5_1_1(), "rule__Test__InputParameterTypesAssignment_5_1_1");
					put(grammarAccess.getTestAccess().getOutputParameterTypesAssignment_8(), "rule__Test__OutputParameterTypesAssignment_8");
					put(grammarAccess.getTestAccess().getOutputParameterTypesAssignment_9_1(), "rule__Test__OutputParameterTypesAssignment_9_1");
