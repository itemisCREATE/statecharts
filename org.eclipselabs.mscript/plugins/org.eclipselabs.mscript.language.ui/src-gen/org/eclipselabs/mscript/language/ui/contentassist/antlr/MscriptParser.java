		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFeatureCallAccess().getTargetAssignment_1(), "rule__FeatureCall__TargetAssignment_1");
					put(grammarAccess.getFeatureCallAccess().getPartsAssignment_2(), "rule__FeatureCall__PartsAssignment_2");
