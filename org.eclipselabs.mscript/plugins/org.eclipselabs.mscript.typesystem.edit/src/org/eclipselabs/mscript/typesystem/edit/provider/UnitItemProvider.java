...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.mscript.typesystem.Unit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Unit_scale_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Unit_scale_feature", "_UI_Unit_type"),
				 TypeSystemPackage.Literals.UNIT__SCALE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Unit_type") + " " + unit.getScale();
	}
