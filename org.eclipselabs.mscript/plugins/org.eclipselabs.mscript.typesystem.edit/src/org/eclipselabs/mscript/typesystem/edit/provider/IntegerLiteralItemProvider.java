...
public class IntegerLiteralItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerLiteral_data_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerLiteral_data_feature", "_UI_IntegerLiteral_type"),
				 TypeSystemPackage.Literals.INTEGER_LITERAL__DATA,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		IntegerData labelValue = ((IntegerLiteral)object).getData();
